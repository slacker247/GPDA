...
static VOID BsaveFind()
  {
   ...
   struct templateSlot *theSlot;   /* changed 03-11-96 */
         ...
         if (theDeftemplate->fuzzyTemplate != NULL)
           {
             ...
             */
             ...
             if (theDeftemplate->fuzzyTemplate->units != NULL)
                theDeftemplate->fuzzyTemplate->units->neededSymbol = CLIPS_TRUE;
      ...
      /*=============================================================*/
         ...
         for (theSlot = theDeftemplate->slotList;
              ...
              theSlot = theSlot->next)
           {
            ...
            theSlot->slotName->neededSymbol = CLIPS_TRUE;
           }
        }
...
GetNextDeftemplate(theDeftemplate);
          }
...
#if FUZZY_DEFTEMPLATES    /* added 03-20-96 */
...
static VOID BloadStorage()
  {
   ...
   if (NumberOfFuzzyTemplates == 0)
   ...
   else
     {
      ...
      LvPlusUniverseArray = (struct fuzzyLv HUGE_ADDR *) genlongalloc(space);
     }
