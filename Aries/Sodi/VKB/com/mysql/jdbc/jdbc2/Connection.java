...
     * By default, the map returned is empty.
    ...
    class UltraDevWorkAround implements java.sql.CallableStatement {
        ...
        public int executeUpdate(String s, String[] ss)
        {return 0;}
        ...
        public boolean execute(String s, String[] ss)
        {return false;}
        ...
        public void registerOutParameter(String s, int y)
        {}
        
        public void registerOutParameter(String s, int i, int x)
        {}

        public void registerOutParameter(String s, int x, String l)
        {}
        ...
        public void setShort(String s, short t)
        {}
        ...
        public void setBigDecimal(String s, java.math.BigDecimal bd)
        {}
        
        public void setString(String s, String ss)
        {}
        
        public void setBytes(String s, byte[] b)
        {}
        
        public void setDate(String s, java.sql.Date d)
        {}
        
        public void setTime(String s, java.sql.Time t)
        {}
        
        public void setTimestamp(String s, java.sql.Timestamp ts)
        {}
        
        public void setAsciiStream(String s, java.io.InputStream is, int i)
        {}
        
        public void setBinaryStream(String s, java.io.InputStream is, int i)
        {}
        
        public void setObject(String s, Object o, int i, int x)
        {}
        ...
        public void setCharacterStream(String s, java.io.Reader r, int i)
        {}
        
        public void setDate(String s, java.sql.Date d, java.util.Calendar c)
        {}
        
        public void setTime(String s, java.sql.Time t, java.util.Calendar c)
        {}
        
        public void setTimestamp(String s, java.sql.Timestamp ts, java.util.Calendar c)
        {}
        
        public void setNull(String s, int i, String ss)
        {}
        ...
        public java.sql.Time getTime(String s)
        {return null;}
        
        public java.sql.Timestamp getTimestamp(String s)
        {return null;}
        
        public java.io.InputStream getAsciiStream(String s)
        {return null;}
        
        public java.io.InputStream getBinaryStream(String s)
        {return null;}
    ...
    public void getMoreResults(int i)
    {}
    ...
    public java.sql.Statement createStatement(int i, int j, int x)
    {return null;}
    
    public java.sql.PreparedStatement prepareStatement(String s, int i, int x, int y)
    {return null;}
    
    public java.sql.CallableStatement prepareCall(String s, int x, int y, int z)
    {return null;}
    
    public java.sql.PreparedStatement prepareStatement(String s, int x)
    {return null;}
    ...
    public java.sql.PreparedStatement prepareStatement(String s, String[] ss)
    {return null;}
}
