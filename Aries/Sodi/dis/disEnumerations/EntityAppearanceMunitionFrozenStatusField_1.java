/*
 File:		EntityAppearanceMunitionFrozenStatusField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Entity Appearance Munition Frozen Status Field -- Describes the frozen status of a guided munition
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityAppearanceMunitionFrozenStatusField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/59.htm">Entity Appearance Munition Frozen Status Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/59.htm">Entity Appearance Munition Frozen Status Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityAppearanceMunitionFrozenStatusField.FROZEN</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityAppearanceMunitionFrozenStatusField.java"><i>EntityAppearanceMunitionFrozenStatusField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearanceMunitionFrozenStatusField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearanceMunitionFrozenStatusField.java</i></a>
 *
 */
public class EntityAppearanceMunitionFrozenStatusField_1 extends Object
{
/**
 *(0) Not Frozen
 */
...
/**
 *(1) Frozen(Frozen entities should not be dead reckoned)
 */
 ...
 * as in <b><code>EntityAppearanceMunitionFrozenStatusField.toString (0)</code></b> returns the string "<b><code>NOTFROZEN</code></b>"
 */
...
public static String toString(int idNumber) 
{
	switch (idNumber) {
		...
		case 1: return "Frozen(Frozen entities should not be dead reckoned)"; 
		default : return "";
	}
}//end of toString
}//End of class 
