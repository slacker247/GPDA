/** Header file generated with fdesign on Mon Sep 29 15:26:11 2003.**/

#ifndef FD_network_h_
#define FD_network_h_
...
extern void DSBnoneCB(FL_OBJECT *, long);
extern void dspexecCB(FL_OBJECT *, long);
extern void dspupdateCB(FL_OBJECT *, long);
extern void dspstratCB(FL_OBJECT *, long);
extern void DSPexitCB(FL_OBJECT *, long);
...
extern FD_dsevedit * create_form_dsevedit(void);
typedef struct {
	FL_FORM *dsnetedit;
	void *vdata;
	char *cdata;
...
typedef struct {
	...
	char *cdata;
	long  ldata;
	FL_OBJECT *netedBnode;
	FL_OBJECT *netedfuseB;
	FL_OBJECT *netedfuseD;
	FL_OBJECT *netedB_b_value;
	FL_OBJECT *netedB_d_value;
	FL_OBJECT *netedB_t_value;
} FD_netedfuse;

extern FD_netedfuse * create_form_netedfuse(void);
typedef struct {
	FL_FORM *neteditor;
	void *vdata;
	char *cdata;
...
typedef struct {
	...
	char *cdata;
	long  ldata;
	FL_OBJECT *story_plot;
	FL_OBJECT *story_browse;
	FL_OBJECT *story_hypoth;
	FL_OBJECT *story_count;
} FD_storygraph;

extern FD_storygraph * create_form_storygraph(void);
typedef struct {
	FL_FORM *dsbplan;
	void *vdata;
	char *cdata;
...
extern FD_dsbplan * create_form_dsbplan(void);
