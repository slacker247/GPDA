/** Header file generated with fdesign on Mon Nov 17 10:14:59 2003.**/
...
extern void BMCnoneCB(FL_OBJECT *, long);
extern void bmcprintCB(FL_OBJECT *, long);
...
typedef struct {
	...
	FL_OBJECT *bmc_feed;
	FL_OBJECT *bmc_incount;
	FL_OBJECT *bmc_alarmcount;
	FL_OBJECT *bmc_title;
...
typedef struct {
	...
	FL_OBJECT *prt_name;
	FL_OBJECT *prt_fname;
	FL_OBJECT *prt_autogen;
	FL_OBJECT *prt_land;
	FL_OBJECT *prt_port;
	FL_OBJECT *prt_optfname;
	FL_OBJECT *prt_pagenum;
	FL_OBJECT *prt_border;
	FL_OBJECT *prt_margin;
	FL_OBJECT *classgroup;
	FL_OBJECT *prt_unclass;
	FL_OBJECT *prt_confid;
	FL_OBJECT *prt_secret;
	FL_OBJECT *prt_propriet;
} FD_printform;

extern FD_printform * create_form_printform(void);
