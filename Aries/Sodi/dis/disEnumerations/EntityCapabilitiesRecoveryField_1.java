/*
 File:		EntityCapabilitiesRecoveryField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Entity Capabilities Recovery Field -- The Entity is able to provide recovery (e.g. towing) services in response to an appropriate Service Request PDU.
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityCapabilitiesRecoveryField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/6a.htm">Entity Capabilities Recovery Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/6a.htm">Entity Capabilities Recovery Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityCapabilitiesRecoveryField.TRUE</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityCapabilitiesRecoveryField.java"><i>EntityCapabilitiesRecoveryField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityCapabilitiesRecoveryField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityCapabilitiesRecoveryField.java</i></a>
 *
 */
public class EntityCapabilitiesRecoveryField_1 extends Object
{
/**
 *(0) False
 */
 ...
 * as in <b><code>EntityCapabilitiesRecoveryField.toString (0)</code></b> returns the string "<b><code>FALSE</code></b>"
 */
