...
public class ConfigureBrowserAction extends AbstractAction{
  private BrowserManager _manager;

  public ConfigureBrowserAction(BrowserManager manager) {
    super("Configure Browser", Icons.getCustomizedFormIcon());
    this._manager = manager;
  }

  public void actionPerformed(ActionEvent e) {
    _manager.configureBrowser();
  }
}