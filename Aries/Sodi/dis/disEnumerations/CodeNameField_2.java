...
/**
 * Code Name Field -- This field shall identify the code name for the designator system. This field shall be represented by a 16-bit enumeration (see Section 8 in EBV-DOC).
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.CodeNameField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/d4.htm">Code Name Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/d4.htm">Code Name Field</A> (SISO)
 ...
 *  You access this via something like <b><code>CodeNameField.TBD</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/CodeNameField.java"><i>CodeNameField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/CodeNameField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/CodeNameField.java</i></a>
 *
 */
public class CodeNameField_2 extends Object
{
/**
 *(0) Other
 */
 ...
 * as in <b><code>CodeNameField.toString (0)</code></b> returns the string "<b><code>OTHER</code></b>"
 */
