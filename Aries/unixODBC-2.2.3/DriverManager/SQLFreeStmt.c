 ...
 **********************************************************************
 *
 * $Id: SQLFreeStmt.c,v 1.3 2002/07/04 17:27:56 lurcher Exp $
 *
 * $Log: SQLFreeStmt.c,v $
...
static char const rcsid[]= "$RCSfile: SQLFreeStmt.c,v $ $Revision: 1.3 $";
           ...
           SQLUSMALLINT option )
{
    ...
    switch ( option )
    {
      ...
      case SQL_DROP:
         ...
         */
        thread_release( SQL_HANDLE_STMT, statement );
        return function_return( statement, 
                __SQLFreeHandle( SQL_HANDLE_STMT, statement_handle ));
