/*
 File:		EntityAppearanceEnvironmentalDensityField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Entity Appearance Environmental Density Field -- Describes the density of the environmentals
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityAppearanceEnvironmentalDensityField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/63.htm">Entity Appearance Environmental Density Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/63.htm">Entity Appearance Environmental Density Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityAppearanceEnvironmentalDensityField.OPAQUE</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityAppearanceEnvironmentalDensityField.java"><i>EntityAppearanceEnvironmentalDensityField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearanceEnvironmentalDensityField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearanceEnvironmentalDensityField.java</i></a>
 *
 */
public class EntityAppearanceEnvironmentalDensityField_1 extends Object
{
/**
 *(0) Clear
 */
 ...
 *(1) Hazy
 */
public static final short HAZY = 1;

/**
 *(2) Dense
 */
public static final short DENSE = 2;

/**
 *(3) Very Dense
 */
public static final short VERYDENSE = 3;

/**
 *(4) Opaque
 */
public static final short OPAQUE = 4;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>EntityAppearanceEnvironmentalDensityField.toString (0)</code></b> returns the string "<b><code>CLEAR</code></b>"
 */
