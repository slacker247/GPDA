...
import browser.model.LibraryItem;
 ...
 *
 * @author Daniel Green - Superliminal Software http://www.superliminal.com
 */
public class JarLoader  {
            ...
            Class loaded_class = new ClassLoader()  {
                public Class findClass(String name) {
                    ...
                    if(loaded_class_entry == null) {
                        System.out.println("loaded_class_entry is null: " + name);
                        return(null);
                    }
                    try {
    ...
    public static void main(String args[]) {
        ...
        //JarLoader the_loader = new JarLoader("Loadable-Class", TestLoadableBase.class,
          //"C:\\Program Files\\Protege-2000\\plugins", true);
        JarLoader the_loader = new JarLoader("LibraryItem", LibraryItem.class,
          "C:\\Documents and Settings\\Warren Shen\\Desktop\\Project Browser\\plugins\\", true);
