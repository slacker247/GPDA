...
/**************************************/
/* WatchCommand: CLIPS access routine */
...
/****************************************/
/* UnwatchCommand: CLIPS access routine */
...
/************************************************/
/* ListWatchItemsCommand: CLIPS access routines */
...
static BOOLEAN RecognizeWatchRouters(log)
  char *log;
  {
   if (strcmp(log,WTRACE) == 0) return(CLIPS_TRUE);
