...
extern void XPSinit();
extern void XPSshow(int xpos, int ypos, int width, int height, Window winid);
...
{
int             XPSwinX = 120, XPSwinY = 120;
int             XPSwinW = 850, XPSwinH = 460;
Window          mainwinID = 0;
//
...
//
   ...
   XPSshow(XPSwinX, XPSwinY, XPSwinW, XPSwinH, mainwinID);
