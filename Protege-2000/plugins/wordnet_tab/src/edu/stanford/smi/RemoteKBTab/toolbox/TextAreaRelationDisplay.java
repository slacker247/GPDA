...
/** Creates a JTextArea to display the text.  Set data takes the array of
 *  strings passed to it and concatenates them together. To use this class,
 *  simply override it and create a new search function. */
public abstract class TextAreaRelationDisplay extends AbstractRelationDisplay {

    JTextArea itsField;
    JPanel itsComp;

    public TextAreaRelationDisplay() {
        createComponents(null, null);
    }

    public TextAreaRelationDisplay(String label, String slot,
    ...
    /** Get the selected string in text area and return them as a string
     *  array. */
