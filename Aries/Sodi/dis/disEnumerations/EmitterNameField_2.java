...
/**
 * Emitter Name Field -- This field shall specify the emitter name for a particular emitter. This field shall be represented by a 16-bit enumberation (see Section 8 in Document EBV-DOC).
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EmitterNameField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/bd.htm">Emitter Name Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/bd.htm">Emitter Name Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EmitterNameField.TBD</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EmitterNameField.java"><i>EmitterNameField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EmitterNameField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EmitterNameField.java</i></a>
 *
 */
public class EmitterNameField_2 extends Object
{
/**
 *(0) Other
 */
 ...
 * as in <b><code>EmitterNameField.toString (0)</code></b> returns the string "<b><code>OTHER</code></b>"
 */
