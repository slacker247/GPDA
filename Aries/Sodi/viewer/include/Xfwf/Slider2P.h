 ...
 */
#ifndef _XFWF_SLIDER2P_H
#define _XFWF_SLIDER2P_H
...
typedef void (*bound_point_Proc)(
#if NeedFunctionPrototypes
Widget,Position *,Position *,Dimension *,Dimension *
#endif
);
#define XtInherit_bound_point ((bound_point_Proc) _XtInherit)
...
typedef void (*start_method_Proc)(
#if NeedFunctionPrototypes
Widget,XEvent *
#endif
);
#define XtInherit_start_method ((start_method_Proc) _XtInherit)
typedef void (*finish_method_Proc)(
#if NeedFunctionPrototypes
Widget,XEvent *
#endif
);
#define XtInherit_finish_method ((finish_method_Proc) _XtInherit)
typedef void (*drag_method_Proc)(
#if NeedFunctionPrototypes
Widget,XEvent *
#endif
);
#define XtInherit_drag_method ((drag_method_Proc) _XtInherit)
...
bound_point_Proc bound_point;
scroll_response_Proc scroll_response;
start_method_Proc start_method;
finish_method_Proc finish_method;
drag_method_Proc drag_method;
/* class variables */
