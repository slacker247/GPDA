/*
 File:		EntityPaintSchemeField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Entity Paint Scheme Field -- Describes the paint scheme of the entity
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityPaintSchemeField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/3c.htm">Entity Paint Scheme Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/3c.htm">Entity Paint Scheme Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityPaintSchemeField.CAMOUFLAGE</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityPaintSchemeField.java"><i>EntityPaintSchemeField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityPaintSchemeField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityPaintSchemeField.java</i></a>
 *
 */
public class EntityPaintSchemeField_1 extends Object
{
/**
 *(0) Uniform Color
 */
public static final short UNIFORMCOLOR = 0;

/**
 *(1) Camouflage
 */
public static final short CAMOUFLAGE = 1;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>EntityPaintSchemeField.toString (0)</code></b> returns the string "<b><code>UNIFORMCOLOR</code></b>"
 */

public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "Uniform Color"; 
