...
GR_Tearth::texture_init ()
{
   ...
   glTexParameterf(GL_TEXTURE_2D, p_texps[0], p_texps[1]);
   p_texps[2] = TX_MAGFILTER;
   p_texps[3] = TX_BILINEAR;
   glTexParameterf(GL_TEXTURE_2D, p_texps[2], p_texps[3]);
   p_texps[4] = TX_WRAP_S;
   p_texps[5] = TX_CLAMP;
   glTexParameterf(GL_TEXTURE_2D, p_texps[4], p_texps[5]);
   p_texps[6] = TX_WRAP_T;
   p_texps[7] = TX_CLAMP;
   glTexParameterf(GL_TEXTURE_2D, p_texps[6], p_texps[7]);
   p_texps[8] = TX_TILE;
   p_texps[9]  = 0.0;
   p_texps[10] = 0.0;
   p_texps[11] = .25;
