...
//  private JPanel     amiPanel = new JPanel();
  ...
  protected JPanel createControlPanel()
  {
    ...
    JButton  exitBtn = new JButton("Accept Alert");
    ...
    ctlPanel.add(exitBtn, BorderLayout.PAGE_START);
...
//    glo.setHgap(5);
    ...
    scoreLabel.setText("97");
    probLabel.setText("95");
    ratioLabel.setText("5");
    ofLabel.setText("7");
    simLabel.setText("82");
    ...
    ImageIcon  mapIcon = new ImageIcon("images/navmap2.jpg");
...
//    mainPanel.setLayout(new BoxLayout(mainPanel, BoxLayout.X_AXIS));
  ...
  protected JPanel createTextPanel()
  {
    ...
    greenLabel.setText
      ("Holland Tunnel... Nerve agent release has filled the tunnel...");
    redLabel.setText
      ("Grand Central Station... Bomb detonation at main entrance...");
