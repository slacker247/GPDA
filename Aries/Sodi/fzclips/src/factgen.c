...
/****************************************/
   ...
   globle struct entityRecord   FactJNGV1Info = { FACT_JN_VAR1,0,1,0,
                                                  PrintFactJNGetVar1,
                                                  PrintFactJNGetVar1,NULL, 
                                                  FactJNGetVar1,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };
                                               
   globle struct entityRecord   FactJNGV2Info = { FACT_JN_VAR2,0,1,0,
                                                  PrintFactJNGetVar2,
                                                  PrintFactJNGetVar2,NULL, 
                                                  FactJNGetVar2,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };
                                                
   globle struct entityRecord   FactJNGV3Info = { FACT_JN_VAR3,0,1,0,
                                                  PrintFactJNGetVar3,
                                                  PrintFactJNGetVar3,NULL, 
                                                  FactJNGetVar3,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };
                                               
   globle struct entityRecord   FactPNGV1Info = { FACT_PN_VAR1,0,1,0,
                                                  PrintFactPNGetVar1,
                                                  PrintFactPNGetVar1,NULL, 
                                                  FactPNGetVar1,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };
                                                  
   globle struct entityRecord   FactPNGV2Info = { FACT_PN_VAR2,0,1,0,
                                                  PrintFactPNGetVar2,
                                                  PrintFactPNGetVar2,NULL, 
                                                  FactPNGetVar2,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };
                                                  
   globle struct entityRecord   FactPNGV3Info = { FACT_PN_VAR3,0,1,0,
                                                  PrintFactPNGetVar3,
                                                  PrintFactPNGetVar3,NULL, 
                                                  FactPNGetVar3,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };
                                                                                              
   globle struct entityRecord   FactJNCV1Info = { FACT_JN_CMP1,0,1,1,
                                                  PrintFactJNCompVars1,
                                                  PrintFactJNCompVars1,NULL,
                                                  FactJNCompVars1,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };
                                               
   globle struct entityRecord   FactJNCV2Info = { FACT_JN_CMP2,0,1,1,
                                                  PrintFactJNCompVars2,
                                                  PrintFactJNCompVars2,NULL,
                                                  FactJNCompVars2,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };
                                               
   globle struct entityRecord   FactPNCV1Info = { FACT_PN_CMP1,0,1,1,
                                                  PrintFactPNCompVars1,
                                                  PrintFactPNCompVars1,NULL,
                                                  FactPNCompVars1,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };
                                                
   globle struct entityRecord   FactStoreMFInfo = { FACT_STORE_MULTIFIELD,0,1,0,
                                                    NULL,NULL,NULL,
                                                    FactStoreMultifield,
                                                    NULL,NULL,NULL,NULL,NULL,NULL };
                                                
   globle struct entityRecord   FactSlotLengthInfo = { FACT_SLOT_LENGTH,0,1,0,
                                                       PrintFactSlotLength,
                                                       PrintFactSlotLength,NULL,
                                                       FactSlotLength,
                                                       NULL,NULL,NULL,NULL,NULL,NULL };
                                                   
   globle struct entityRecord   FactPNConstant1Info = { FACT_PN_CONSTANT1,0,1,1,
                                                        PrintFactPNConstant1,
                                                        PrintFactPNConstant1,NULL,
                                                        FactPNConstant1,
                                                        NULL,NULL,NULL,NULL,NULL,NULL };
                                                   
   globle struct entityRecord   FactPNConstant2Info = { FACT_PN_CONSTANT2,0,1,1,
   ...
   globle struct entityRecord   FactPNFuzzyValue = { SCALL_PN_FUZZY_VALUE,0,0,1,
                                                       PrintPNFUZZY_VALUE,
  ...
  struct lhsParseNode *theField;
  {
   ...
   if (theField->withinMultifieldSlot == CLIPS_FALSE)
     {   
      ...
      if (theField->negated) hack1.testForEquality = CLIPS_FALSE;
      else hack1.testForEquality = CLIPS_TRUE;
   ...
   /*=================================================================*/
     ...
     {   
      ...
      if (theField->multiFieldsBefore == 0)
        {
         hack2.fromBeginning = CLIPS_TRUE;
         hack2.offset = theField->singleFieldsBefore;
        }
      else
        {
         hack2.fromBeginning = CLIPS_FALSE;
