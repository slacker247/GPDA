/*
 File:		ReferenceSystemField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Reference System Field -- This section specifies the 8-bit enumeration of the Reference System field in the Beam Antenna Pattern record and the Spherical Harmonic Pattern Record in the Transmitter PDU.  The enumeration for the Reference System are limited to the two list below.
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.ReferenceSystemField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/10c.htm">Reference System Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/10c.htm">Reference System Field</A> (SISO)
 ...
 *  You access this via something like <b><code>ReferenceSystemField.ENTITYCOORDINATES</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/ReferenceSystemField.java"><i>ReferenceSystemField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/ReferenceSystemField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/ReferenceSystemField.java</i></a>
 *
 */
public class ReferenceSystemField_1 extends Object
{
/**
 *(1) World Coordinates
 */
public static final short WORLDCOORDINATES = 1;

/**
 *(2) Entity Coordinates
 */
public static final short ENTITYCOORDINATES = 2;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>ReferenceSystemField.toString (1)</code></b> returns the string "<b><code>WORLDCOORDINATES</code></b>"
 */

public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 1: return "World Coordinates"; 
		case 2: return "Entity Coordinates"; 
		default : return "";
	}
}//end of toString
}//End of class 
