...
extern "C" void delete_list_element(LIST **p_list, int idx);
extern "C" void destroy_list(LIST **p_list);
extern "C" int build_argv(ARGV **p_argv, const char *data);
extern "C" void delete_argv_element(ARGV **p_argv, int idx);
extern "C" void destroy_argv(ARGV **p_argv);
