...
/* FUZZY_DEFTEMPLATES  -- must be added even if fuzzy stuff not in system */
   PrimitiveClassMap[FUZZY_VALUE] = 
     LookupDefclassByMdlOrScope(FUZZY_VALUE_NAME);
...
/* FUZZY_DEFTEMPLATES -- must be added even if fuzzy stuff not in system */
   PrimitiveClassMap[FUZZY_VALUE] = AddSystemClass(FUZZY_VALUE_NAME,primitive);
...
/* FUZZY_DEFTEMPLATES -- must be added even if fuzzy stuff not in system */
   AddConstructToModule((struct constructHeader *) PrimitiveClassMap[FUZZY_VALUE]);
