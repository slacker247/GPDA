...
public class ResultSet
	 ...
	 */
	 ...
	 void syncUpdate() throws SQLException {
		...
		if (_Updater == null) {
			...
			_Updater =
				(com.mysql.jdbc.jdbc2.PreparedStatement) _connection.prepareStatement(_UpdateSQL);
		}
	...
	protected  void setResultSetConcurrency(int concurrencyFlag) {
        ...
        public void updateClob(int i, java.sql.Clob c)
        {}

        public void updateClob(String s, java.sql.Clob c)
        {}
        
        public void updateArray(int i, java.sql.Array a)
        {}
        
        public void updateArray(String s, java.sql.Array a)
        {}
}
