/*
 File:		EntityMobilityKillField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Entity Mobility Kill Field -- Describes visual effects characteristic of Mobility Kills
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityMobilityKillField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/3d.htm">Entity Mobility Kill Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/3d.htm">Entity Mobility Kill Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityMobilityKillField.MOBILITYKILL</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityMobilityKillField.java"><i>EntityMobilityKillField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityMobilityKillField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityMobilityKillField.java</i></a>
 *
 */
public class EntityMobilityKillField_1 extends Object
{
/**
 *(0) No Mobility Kill
 */
public static final short NOMOBILITYKILL = 0;

/**
 *(1) Mobility Kill
 */
public static final short MOBILITYKILL = 1;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>EntityMobilityKillField.toString (0)</code></b> returns the string "<b><code>NOMOBILITYKILL</code></b>"
 */

public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "No Mobility Kill"; 
		case 1: return "Mobility Kill"; 
		default : return "";
	}
}//end of toString
}//End of class 
