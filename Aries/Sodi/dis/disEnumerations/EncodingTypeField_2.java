 ...
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EncodingTypeField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/117.htm">Encoding Type Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/117.htm">Encoding Type Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EncodingTypeField.VQ</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EncodingTypeField.java"><i>EncodingTypeField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EncodingTypeField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EncodingTypeField.java</i></a>
 *
 */
public class EncodingTypeField_2 extends Object
{
/**
 *(1) 8-bit mu-law
 */
public static final short ENUMERATION8BITMULAW = 1;

/**
 *(2) CVSD per MIL-STD-188-113
 */
public static final short CVSDPERMILSTD188113 = 2;

/**
 *(3) ADPCM per CCITT G721
 */
public static final short ADPCMPERCCITTG721 = 3;

/**
 *(4) 16-bit linear PCM
 */
public static final short ENUMERATION16BITLINEARPCM = 4;

/**
 *(5) 8-bit linear PCM
 */
public static final short ENUMERATION8BITLINEARPCM = 5;
 ...
 * as in <b><code>EncodingTypeField.toString (1)</code></b> returns the string "<b><code>ENUMERATION8BITMULAW</code></b>"
 */
...
public static String toString(int idNumber) 
{
	switch (idNumber) {
		...
		case 2: return "CVSD per MIL-STD-188-113"; 
		case 3: return "ADPCM per CCITT G721"; 
		case 4: return "16-bit linear PCM"; 
		case 5: return "8-bit linear PCM"; 
		case 6: return "VQ (Vector Quantization)"; 
		default : return "";
	}
}//end of toString
}//End of class 
