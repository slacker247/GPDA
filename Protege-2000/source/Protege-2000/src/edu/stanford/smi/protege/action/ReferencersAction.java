...
public class ReferencersAction extends AllowableAction {
    ...
    public ReferencersAction(Selectable s) {
        super("References", "Display references to selected instance", Icons.getUpIcon(), s);
    }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (selection.size() == 1) {
            ...
            int n = panel.getReferencerCount();
            String title = "References to " + instance.getBrowserText() + "   (" + n + ")";
