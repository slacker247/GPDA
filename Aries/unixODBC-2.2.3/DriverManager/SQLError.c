 ...
 **********************************************************************
 *
 * $Id: SQLError.c,v 1.5 2002/08/23 09:42:37 lurcher Exp $
 *
 * $Log: SQLError.c,v $
...
static char const rcsid[]= "$RCSfile: SQLError.c,v $ $Revision: 1.5 $";
        ...
        DMHDBC connection )
{
    ...
    if ( SQL_SUCCEEDED( ret ) && sqlstate )
        __map_error_state( sqlstate, __get_version( head ));
