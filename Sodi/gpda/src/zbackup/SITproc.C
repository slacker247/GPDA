...
Window          winid;
   ...
   sprintf(scline, "%-8s   %-16s  %4d %4d", "Russia", "www.housecall.ro", 0, 8);
   fl_addto_browser(fd_sitaware->sit_threats, scline);
   */
   fl_clear_chart(fd_sitaware->sit_durable[3]);
   fl_add_chart_value(fd_sitaware->sit_durable[3], (double)6.0, "Up",    FL_GREEN);
   fl_add_chart_value(fd_sitaware->sit_durable[3], (double)2.0, "Down",  FL_RED);
   fl_add_chart_value(fd_sitaware->sit_durable[3], (double)1.0, "Avail", FL_YELLOW);

   fl_clear_chart(fd_sitaware->sit_durable[4]);
   fl_add_chart_value(fd_sitaware->sit_durable[4], (double)16.0, "Known",  FL_GREEN);
   fl_add_chart_value(fd_sitaware->sit_durable[4], (double)6.0,  "Susp.",  FL_RED);
   fl_add_chart_value(fd_sitaware->sit_durable[4], (double)2.0,  "Zombie", FL_YELLOW);

   fl_clear_chart(fd_sitaware->sit_durable[5]);
   fl_add_chart_value(fd_sitaware->sit_durable[5], (double)2016.0, "Active", FL_GREEN);
   fl_add_chart_value(fd_sitaware->sit_durable[5], (double)360.0,  "Inact.", FL_RED);
   fl_add_chart_value(fd_sitaware->sit_durable[5], (double)52.0,   "New",    FL_YELLOW);
//
...
//
   ...
   fl_set_input(fd_sitaware->sit_dea,    fl_get_input(fd_bmc3->dea_val));
   fl_set_input(fd_sitaware->sit_roe,    fl_get_object_label(fd_bmc3->roe_val));
  */
//
//   Update the map area
//
