...
demomain ()
{
   ...
   strcpy (BPen_body.intel_info_body_struct.Rpt_Text, "Text 1");
   ...
   strcpy (BPen_body.intel_info_body_struct.Rpt_Text, "Text 2");
   ...
   strcpy (BPen_body.intel_info_body_struct.Rpt_Text, "Text 3");
   ...
   BPen_body.trk_engmt_body_struct.Eng_Opp_Remain  = 3;
   BPen_body.trk_engmt_body_struct.Task_Id         = 2;
