/*
 File:		EntityAppearancePlatformLauncherField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Entity Appearance Platform Launcher Field -- Describes the elevated status of the platforms missile launcher
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityAppearancePlatformLauncherField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/4b.htm">Entity Appearance Platform Launcher Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/4b.htm">Entity Appearance Platform Launcher Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityAppearancePlatformLauncherField.RAISED</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityAppearancePlatformLauncherField.java"><i>EntityAppearancePlatformLauncherField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearancePlatformLauncherField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearancePlatformLauncherField.java</i></a>
 *
 */
public class EntityAppearancePlatformLauncherField_1 extends Object
{
/**
 *(0) Not Raised
 */
public static final short NOTRAISED = 0;

/**
 *(1) Raised
 */
public static final short RAISED = 1;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>EntityAppearancePlatformLauncherField.toString (0)</code></b> returns the string "<b><code>NOTRAISED</code></b>"
 */

public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "Not Raised"; 
