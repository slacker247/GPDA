/*
 File:		ProtocolVersionField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
 ...
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.ProtocolVersionField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/5.htm">Protocol Version Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/5.htm">Protocol Version Field</A> (SISO)
 ...
 *  You access this via something like <b><code>ProtocolVersionField.IEEE127811995</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/ProtocolVersionField.java"><i>ProtocolVersionField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/ProtocolVersionField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/ProtocolVersionField.java</i></a>
 *
 */
public class ProtocolVersionField_1 extends Object
{
/**
 *(0) Other
 */
 ...
 */
public static final short DISPDUVERSION10 = 1;

/**
 *(2) IEEE 1278-1993
 */
public static final short IEEE12781993 = 2;

/**
 *(3) DIS PDU version 20 - third draft (May 93)
 */
public static final short DISPDUVERSION20THIRDDRAFT = 3;

/**
 *(4) DIS PDU version 20 - fourth draft (revised) March 16, 1994
 */
public static final short DISPDUVERSION20FOURTHDRAFTMARCH161994 = 4;

/**
 *(5) IEEE 12781-1995
 */
public static final short IEEE127811995 = 5;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>ProtocolVersionField.toString (0)</code></b> returns the string "<b><code>OTHER</code></b>"
 */
...
public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "Other"; 
		case 1: return "DIS PDU version 10 (May 92)"; 
		case 2: return "IEEE 1278-1993"; 
		case 3: return "DIS PDU version 20 - third draft (May 93)"; 
		case 4: return "DIS PDU version 20 - fourth draft (revised) March 16, 1994"; 
		case 5: return "IEEE 12781-1995"; 
		default : return "";
	}
}//end of toString
}//End of class 
