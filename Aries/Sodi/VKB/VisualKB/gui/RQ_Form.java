...
public class RQ_Form extends JDialog {
    ...
    public javax.swing.JLabel jL_Field2;
    public javax.swing.JLabel jL_Field3;
    public javax.swing.JLabel jL_Field4;
    public javax.swing.JLabel jL_Field5;
    public javax.swing.JLabel jL_Field6;
    public javax.swing.JLabel jL_Field7;
    public javax.swing.JLabel jL_Field8;
    public javax.swing.JLabel jL_Field9;
    public javax.swing.JLabel jL_Field10;
    public javax.swing.JLabel jL_Field11;
    public javax.swing.JLabel jL_Field12;
    public javax.swing.JLabel jL_Field13;
    public javax.swing.JLabel jL_Field14;
    public javax.swing.JLabel jL_Field15;
    public javax.swing.JLabel jL_Field16;
    public javax.swing.JLabel jL_Field17;
    public javax.swing.JLabel jL_Field18;
    public javax.swing.JLabel jL_Field19;
    public javax.swing.JLabel jL_Field20;
    public javax.swing.JLabel jL_Field21;
    public javax.swing.JLabel jL_Field22;
    public javax.swing.JLabel jL_Field23;
    public javax.swing.JLabel jL_Field24;
    public javax.swing.JLabel jL_Field25;
    public javax.swing.JLabel jL_Field26;
    public javax.swing.JLabel jL_Field27;
    public javax.swing.JLabel jL_Field28;
    public javax.swing.JLabel jL_Field29;
    public javax.swing.JLabel jL_Field30;
    public javax.swing.JLabel jL_Field31;
    public javax.swing.JLabel jL_Field32;
    public javax.swing.JLabel jL_Field33;
    public javax.swing.JLabel jL_Field34;
    public javax.swing.JLabel jL_Field35;
    public javax.swing.JLabel jL_Field36;
    public javax.swing.JLabel jL_Field37;
    public javax.swing.JLabel jL_Field38;
    public javax.swing.JLabel jL_Field39;
    public javax.swing.JLabel jL_Field40;
    public javax.swing.JLabel jL_Field41;
    public javax.swing.JLabel jL_Field42;
    public javax.swing.JLabel jL_Field43;
    public javax.swing.JLabel jL_Field44;
    public javax.swing.JLabel jL_Field45;
    public javax.swing.JLabel jL_Field46;
    public javax.swing.JLabel jL_Field47;
    public javax.swing.JLabel jL_Field48;
    public javax.swing.JLabel jL_Field49;
    public javax.swing.JLabel jL_Field50;
    public javax.swing.JLabel jL_Field51;
    public javax.swing.JLabel jL_Field52;
    ...
    public javax.swing.JLabel jL_Heading1;
    public javax.swing.JLabel jL_Heading2;
    public javax.swing.JLabel jL_Heading3;
    public javax.swing.JLabel jL_Heading4;
    public javax.swing.JLabel jL_Heading5;
    public javax.swing.JLabel jL_Heading6;
    public javax.swing.JLabel jL_Heading7;
    public javax.swing.JLabel jL_Field53;
    ...
    private void jbInit() throws Exception {
      ...
      jL_Heading1.enableInputMethods(true);
    ...
    {
      int Count = 0;
      jL_Field2.setText(Labels[Count++].replace('_',  ' '));
      jL_Field3.setText(Labels[Count++].replace('_',  ' '));
      jL_Field4.setText(Labels[Count++].replace('_',  ' '));
      jL_Field5.setText(Labels[Count++].replace('_',  ' '));
      jL_Heading1.setText(Labels[Count++].replace('_',  ' '));
      jL_Field6.setText(Labels[Count++].replace('_',  ' '));
      jL_Field7.setText(Labels[Count++].replace('_',  ' '));
      jL_Field8.setText(Labels[Count++].replace('_',  ' '));
      jL_Field9.setText(Labels[Count++].replace('_',  ' '));
      jL_Field10.setText(Labels[Count++].replace('_',  ' '));
      jL_Field11.setText(Labels[Count++].replace('_',  ' '));
      jL_Field12.setText(Labels[Count++].replace('_',  ' '));
      jL_Field13.setText(Labels[Count++].replace('_',  ' '));
      jL_Field14.setText(Labels[Count++].replace('_',  ' '));
      jL_Field15.setText(Labels[Count++].replace('_',  ' '));
      jL_Field16.setText(Labels[Count++].replace('_',  ' '));
      jL_Field17.setText(Labels[Count++].replace('_',  ' '));
      jL_Heading2.setText(Labels[Count++].replace('_',  ' '));
      jL_Field18.setText(Labels[Count++].replace('_',  ' '));
      jL_Field19.setText(Labels[Count++].replace('_',  ' '));
      jL_Field20.setText(Labels[Count++].replace('_',  ' '));
      jL_Field21.setText(Labels[Count++].replace('_',  ' '));
      jL_Heading3.setText(Labels[Count++].replace('_',  ' '));
      jL_Field22.setText(Labels[Count++].replace('_',  ' '));
      jL_Field23.setText(Labels[Count++].replace('_',  ' '));
      jL_Field24.setText(Labels[Count++].replace('_',  ' '));
      jL_Field25.setText(Labels[Count++].replace('_',  ' '));
      jL_Field26.setText(Labels[Count++].replace('_',  ' '));
      jL_Field27.setText(Labels[Count++].replace('_',  ' '));
      jL_Field28.setText(Labels[Count++].replace('_',  ' '));
      jL_Field29.setText(Labels[Count++].replace('_',  ' '));
      jL_Heading4.setText(Labels[Count++].replace('_',  ' '));
      jL_Field30.setText(Labels[Count++].replace('_',  ' '));
      jL_Field31.setText(Labels[Count++].replace('_',  ' '));
      jL_Field32.setText(Labels[Count++].replace('_',  ' '));
      jL_Heading5.setText(Labels[Count++].replace('_',  ' '));
      jL_Field33.setText(Labels[Count++].replace('_',  ' '));
      jL_Field34.setText(Labels[Count++].replace('_',  ' '));
      jL_Field35.setText(Labels[Count++].replace('_',  ' '));
      jL_Field36.setText(Labels[Count++].replace('_',  ' '));
      jL_Heading6.setText(Labels[Count++].replace('_',  ' '));
      jL_Field37.setText(Labels[Count++].replace('_',  ' '));
      jL_Field38.setText(Labels[Count++].replace('_',  ' '));
      jL_Field39.setText(Labels[Count++].replace('_',  ' '));
      jL_Field40.setText(Labels[Count++].replace('_',  ' '));
      jL_Field41.setText(Labels[Count++].replace('_',  ' '));
      jL_Field42.setText(Labels[Count++].replace('_',  ' '));
      jL_Field43.setText(Labels[Count++].replace('_',  ' '));
      jL_Field44.setText(Labels[Count++].replace('_',  ' '));
      jL_Heading7.setText(Labels[Count++].replace('_',  ' '));
      jL_Field45.setText(Labels[Count++].replace('_',  ' '));
      jL_Field46.setText(Labels[Count++].replace('_',  ' '));
      jL_Field47.setText(Labels[Count++].replace('_',  ' '));
      jL_Field48.setText(Labels[Count++].replace('_',  ' '));
      jL_Field49.setText(Labels[Count++].replace('_',  ' '));
      jL_Field50.setText(Labels[Count++].replace('_',  ' '));
      jL_Field51.setText(Labels[Count++].replace('_',  ' '));
      jL_Field52.setText(Labels[Count++].replace('_',  ' '));
      jL_Field53.setText(Labels[Count++].replace('_',  ' '));
    }
    ...
    public String[] getLabels()
    {
        ...
        int count = 0;
        Labels[count++] = "-" + jL_Field2.getText().replace(' ', '_');
        Labels[count++] = "-" + jL_Field3.getText().replace(' ', '_');
        Labels[count++] = "-" + jL_Field4.getText().replace(' ', '_');
        Labels[count++] = "-" + jL_Field5.getText().replace(' ', '_');
        Labels[count++] = "+" + jL_Heading1.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field6.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field7.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field8.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field9.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field10.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field11.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field12.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field13.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field14.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field15.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field16.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field17.getText().replace(' ', '_');
        Labels[count++] = "+" + jL_Heading2.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field18.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field19.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field20.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field21.getText().replace(' ', '_');
        Labels[count++] = "+" + jL_Heading3.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field22.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field23.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field24.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field25.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field26.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field27.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field28.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field29.getText().replace(' ', '_');
        Labels[count++] = "+" + jL_Heading4.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field30.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field31.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field32.getText().replace(' ', '_');
        Labels[count++] = "+" + jL_Heading5.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field33.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field34.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field35.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field36.getText().replace(' ', '_');
        Labels[count++] = "+" + jL_Heading6.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field37.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field38.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field39.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field40.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field41.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field42.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field43.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field44.getText().replace(' ', '_');
        Labels[count++] = "+" + jL_Heading7.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field45.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field46.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field47.getText().replace(' ', '_');
        Labels[count++] = ">" + jL_Field48.getText().replace(' ', '_');
        Labels[count++] = "-" + jL_Field49.getText().replace(' ', '_');
        Labels[count++] = "-" + jL_Field50.getText().replace(' ', '_');
        Labels[count++] = "-" + jL_Field51.getText().replace(' ', '_');
        Labels[count++] = "-" + jL_Field52.getText().replace(' ', '_');
        Labels[count++] = "-" + jL_Field53.getText().replace(' ', '_');
        return Labels;
    }
