...
/**
 *  This code was copied from the JDK LinkedList class and hacked. (rwf)
 *
 * @author    Ray Fergerson <fergerson@smi.stanford.edu>
 */
public class HashList extends AbstractSequentialList
         implements ExtendedList, Cloneable, java.io.Serializable {
    private transient Entry header = new Entry(null, null, null);
    private transient int size = 0;
    private Map _itsValueEntryMap = new HashMap();

    private List itsUnmodifiableList;
    ...
    private void addHashEntry(Entry e) {
        Object o = e.element;
        Object entryOrList = _itsValueEntryMap.get(o);
        if (entryOrList == null) {
            _itsValueEntryMap.put(o, e);
    ...
    private boolean containsHashKey(Object o) {
        return _itsValueEntryMap.containsKey(o);
    }
    ...
    public List getUnmodifiableList() {
        if (itsUnmodifiableList == null) {
            itsUnmodifiableList = Collections.unmodifiableList(this);
        }
        return itsUnmodifiableList;
    }
