 ...
 **********************************************************************
 *
 * $Id: SQLExecute.c,v 1.4 2002/07/18 15:21:57 lurcher Exp $
 *
 * $Log: SQLExecute.c,v $
...
static char const rcsid[]= "$RCSfile: SQLExecute.c,v $ $Revision: 1.4 $";
...
#ifdef CRIPPLEDFORDEMO
	static int nDemoCount = 1;
	...
	if ( nDemoCount > 1 )
	{
        dm_log_write( __FILE__,
                __LINE__,
                    LOG_INFO,
                    LOG_INFO,
                    "Error: DEMO does not support connections." );
