      subroutine threatinit(index, misstype, Plaunch, Pimpact,
     +                       Tlaunch, Limpact)
      integer     index
...
c     write(*,*) threat_type(ind), '   ', threat_impact(ind)
      ...
      subroutine threatsetup(x1, x2, x3, v1, v2, v3, 
...
10      continue
   ...
   40 continue
      ...
      subroutine getassign (i, thrt, weap, etime)
