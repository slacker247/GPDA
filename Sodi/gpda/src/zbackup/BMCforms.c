...
FD_bmc3 *create_form_bmc3(void)
{
  ...
  fdui->alarm_button = obj = fl_add_button(FL_NORMAL_BUTTON,10,50,110,20,"");
  ...
  fdui->bmctop_browser = obj = fl_add_browser(FL_NORMAL_BROWSER,635,485,315,180,"");
    fl_set_object_boxtype(obj,FL_FRAME_BOX);
  ...
  fdui->bmc_mission = obj = fl_add_pixmap(FL_NORMAL_PIXMAP,635,210,315,240,"Mission Area");
    fl_set_object_boxtype(obj,FL_FRAME_BOX);
  ...
  fdui->bmc_message = obj = fl_add_input(FL_NORMAL_INPUT,190,685,800,20,"Message");
    fl_set_object_boxtype(obj,FL_UP_BOX);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,BMCnoneCB,0);
...
FD_sitmonitor *create_form_sitmonitor(void)
{
  ...
  fdui->sitmonitor = fl_bgn_form(FL_NO_BOX, 425, 330);
  obj = fl_add_box(FL_UP_BOX,0,0,425,330,"");
...
FD_sitaware *create_form_sitaware(void)
{
  ...
  fdui->sit_durable[5] = obj = fl_add_chart(FL_HORBAR_CHART,200,375,85,65,"IDS Rules");
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,SITnoneCB,0);
  fdui->sit_durable[2] = obj = fl_add_chart(FL_BAR_CHART,200,293,85,65,"Firewall Status");
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,SITnoneCB,0);
  fdui->sit_durable[1] = obj = fl_add_chart(FL_BAR_CHART,105,293,85,65,"Firewall Status");
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,SITnoneCB,0);
  fdui->sit_durable[0] = obj = fl_add_chart(FL_BAR_CHART,10,293,85,65,"Firewall Status");
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,SITnoneCB,0);
  fl_end_form();
...
FD_statsubs *create_form_statsubs(void)
{
  ...
  obj = fl_add_text(FL_NORMAL_TEXT,55,15,380,30,"Sub-System Status");
    ...
    fl_set_object_lalign(obj,FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
    fl_set_object_lstyle(obj,FL_BOLDITALIC_STYLE);
  obj = fl_add_lightbutton(FL_PUSH_BUTTON,30,80,190,30,"Battle Manager");
    fl_set_object_color(obj,FL_GREEN,FL_GREEN);
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
  obj = fl_add_lightbutton(FL_PUSH_BUTTON,30,125,190,30,"Execution Monitor");
    fl_set_object_color(obj,FL_RED,FL_RED);
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
  obj = fl_add_lightbutton(FL_PUSH_BUTTON,30,175,190,30,"Simulator");
    fl_set_object_color(obj,FL_RED,FL_RED);
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
  obj = fl_add_lightbutton(FL_PUSH_BUTTON,30,225,190,30,"Fused Operating Picture");
    fl_set_object_color(obj,FL_GREEN,FL_GREEN);
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
  obj = fl_add_lightbutton(FL_PUSH_BUTTON,260,80,190,30,"CIC Interface");
    fl_set_object_color(obj,FL_GREEN,FL_GREEN);
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
  obj = fl_add_lightbutton(FL_PUSH_BUTTON,260,125,190,30,"Multi-Threaded Tools");
    fl_set_object_color(obj,FL_GREEN,FL_GREEN);
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
  fl_end_form();
