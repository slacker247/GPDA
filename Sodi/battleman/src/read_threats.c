/* read_threats.f -- translated by f2c (version 19960717).
...
/*      in = 2 */
/*      open (in, form = 'formatted', status = 'old', file = */
/*     *                                           'arctic.threats') */
/*      do 20 i = 1, MAX_NUM_THREATS */
/*         read(in,*,end=25) (threat_state (i,k),k=1,6), threat_time (i), 
*/
/*     *                      trntry (i) */
/*         threat_id (i) = i + 1000 */
/*         num_threats       = i */
...
/*     write (*, 99) num_threats */
/*   99 format (' number of threats  = ', i4) */
    return 0;
} /* read_threats__ */
