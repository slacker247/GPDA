 ...
 **********************************************************************
 *
 * $Id: SQLSetScrollOptions.c,v 1.4 2002/01/15 10:31:34 lurcher Exp $
 *
...
static char const rcsid[]= "$RCSfile: SQLSetScrollOptions.c,v $ $Revision: 1.4 $";
    ...
    SQLUSMALLINT       crow_rowset )
{
            ...
            CHECK_SQLSETSTMTATTR( statement -> connection ))
    {
        ...
        ret = SQLGETINFO( statement -> connection,
                statement -> connection -> driver_dbc,
                info_type,
                &ivp,
                sizeof( ivp ),
                0 );
