...
#include "constant.h"
/*#include "constrnt.h"       comment out for following reasons   */
#include "tmpltdef.h"      /* added 03-22-96 for syntax error ....*/
#include "cstrnchk.h"
#include "multifld.h"
#include "inscom.h"
#include "exprnpsr.h"
...
globle VOID DeriveDefaultFromConstraints(constraints,theDefault,multifield)
  ...
  int multifield;
  {
   short theType;  /* changed 03-05-96 */
