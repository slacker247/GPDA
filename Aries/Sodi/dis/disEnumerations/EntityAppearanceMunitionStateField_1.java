/*
 File:		EntityAppearanceMunitionStateField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Entity Appearance Munition State Field -- Describes the state of a guided munition
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityAppearanceMunitionStateField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/5a.htm">Entity Appearance Munition State Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/5a.htm">Entity Appearance Munition State Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityAppearanceMunitionStateField.DEACTIVATED</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityAppearanceMunitionStateField.java"><i>EntityAppearanceMunitionStateField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearanceMunitionStateField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearanceMunitionStateField.java</i></a>
 *
 */
public class EntityAppearanceMunitionStateField_1 extends Object
{
/**
 *(0) Active
 */
 ...
 * as in <b><code>EntityAppearanceMunitionStateField.toString (0)</code></b> returns the string "<b><code>ACTIVE</code></b>"
 */
