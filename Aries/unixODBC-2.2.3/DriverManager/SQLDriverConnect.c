 ...
 **********************************************************************
 *
 * $Id: SQLDriverConnect.c,v 1.7 2002/08/23 09:42:37 lurcher Exp $
 *
...
static char const rcsid[]= "$RCSfile: SQLDriverConnect.c,v $ $Revision: 1.7 $";
    ...
    SQLUSMALLINT       driver_completion )
{
    ...
    char *driver, *dsn, *filedsn, *tsavefile, savefile[ 128 ];
                                                ...
                                                conn_str_in, len_conn_str_in ))
    {
        ...
        if ( conn_str_out )
        {
            ...
            {
                memcpy( conn_str_out, conn_str_in, conn_str_out_max );
                conn_str_out[ conn_str_out_max ] = '\0';
                if ( ptr_conn_str_out )
                {
