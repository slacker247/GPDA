...
/**
 * Transmit State field -- This field shall specify whether a radio is off, powered but not transmitting, or powered and transmitting. This field shall be represented by an 8-bit enumberation. (see Section 9 in EBV-DOC).
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.TransmitStatefield feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/e4.htm">Transmit State field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/e4.htm">Transmit State field</A> (SISO)
 ...
 *  You access this via something like <b><code>TransmitStatefield.ONANDTRANSMITTING</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/TransmitStatefield.java"><i>TransmitStatefield.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/TransmitStatefield.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/TransmitStatefield.java</i></a>
 *
 */
public class TransmitStatefield_2 extends Object
{
/**
 *(0) Off
 */
 ...
 */
public static final short ONBUTNOTTRANSMITTING = 1;

/**
 *(2) On and transmitting
 */
public static final short ONANDTRANSMITTING = 2;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>TransmitStatefield.toString (0)</code></b> returns the string "<b><code>OFF</code></b>"
 */
...
public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "Off"; 
		case 1: return "On but not transmitting"; 
		case 2: return "On and transmitting"; 
		default : return "";
	}
}//end of toString
}//End of class 
