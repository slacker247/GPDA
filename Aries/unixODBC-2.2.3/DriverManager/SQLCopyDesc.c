 ...
 **********************************************************************
 *
 * $Id: SQLCopyDesc.c,v 1.1.1.1 2001/10/17 16:40:05 lurcher Exp $
 *
 * $Log: SQLCopyDesc.c,v $
           ...
           SQLHDESC target_desc_handle )
{
            ...
            CHECK_SQLCOPYDESC( src_descriptor -> connection ))
    {
        ...
        return function_return( target_descriptor, ret );
    }
    else
    {
        /*
                ...
                !CHECK_SQLSETDESCFIELD( src_descriptor -> connection ))
        {
            ...
            return function_return( target_descriptor, SQL_ERROR );
        }
