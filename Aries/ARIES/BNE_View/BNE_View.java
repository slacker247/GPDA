...
public class BNE_View extends GAppFrame{
    ...
    public BNE_View() {
        ...
        //BorderEdgeAttachStrategy _attachStrategy;
        //_graphUIPrefs.setBorderEdgeAttachStrategy(_attachStrategy.Y_AXIS);
...
//        KBAccess.test.configuration.setPort(g_Port);
    ...
    //    return (_fileOpenKBAction);
        ...
        public void updateLabel(DrawableNode node, String newLabel)
    {
