...
public abstract class ProtocolDataUnit extends PduElement
{
//*******************************************************************************
...
*/
     ...
     * shall be speciﬁed using a 32-bit unsigned integer
     * representing units of time passed since the beginning of 
     * the current hour. The least signiﬁcant bit shall
     ...
     * of the absolute timestamp shall be signiﬁed by the 
     * least signiﬁcant bit set to one.
     ...
     * shall be signiﬁed by the least signiﬁcant bit set to zero.
     ...
     * each time unit representing 3600 s/(2 31 –1) = 1.676 µs.
     *</dl>
     *</PRE>
     */
