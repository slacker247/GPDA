 ...
 **********************************************************************
 *
 * $Id: SQLDisconnect.c,v 1.5 2002/08/12 13:17:52 lurcher Exp $
 *
...
static char const rcsid[]= "$RCSfile: SQLDisconnect.c,v $ $Revision: 1.5 $";
...
SQLRETURN SQLDisconnect( SQLHDBC connection_handle )
{
    ...
    if ( connection -> pooled_connection )
    {
        ...
        return function_return( connection, SQL_SUCCESS );
    }
    ...
    if ( SQL_SUCCEEDED( ret ))
    {
	    ...
	    {
	        function_return_ex( connection, ret, TRUE );
        }
