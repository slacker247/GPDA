...
/*******************************************************/
globle VOID FlushPPBuffer()  /* changed (int) 03-11-96 */
  {
...
/*   depth for pretty printing.                 */
/************************************************/
globle VOID DecrementIndentDepth(value)  /* changed 03-11-96 */
  int value;
  {
   IndentationDepth -= value;
  }
...
/*   depth for pretty printing.     */
/************************************/
globle VOID SetIndentDepth(value)       /* changed 03-11-96 */
  int value;
  {
   IndentationDepth = value;
  }
