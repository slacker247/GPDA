/*
 File:		EntityFirePowerField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
 ...
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityFirePowerField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/3e.htm">Entity Fire Power Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/3e.htm">Entity Fire Power Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityFirePowerField.FIREPOWERKILL</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityFirePowerField.java"><i>EntityFirePowerField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityFirePowerField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityFirePowerField.java</i></a>
 *
 */
public class EntityFirePowerField_1 extends Object
{
/**
 *(0) No Fire-power kill
 */
public static final short NOFIREPOWERKILL = 0;

/**
 *(1) Fire-power kill
 */
public static final short FIREPOWERKILL = 1;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>EntityFirePowerField.toString (0)</code></b> returns the string "<b><code>NOFIREPOWERKILL</code></b>"
 */

public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "No Fire-power kill"; 
		case 1: return "Fire-power kill"; 
		default : return "";
	}
}//end of toString
}//End of class 
