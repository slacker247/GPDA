...
FD_explain *create_form_explain(void)
{
  ...
  fdui->ds_explain = obj = fl_add_browser(FL_NORMAL_BROWSER,620,60,220,230,"Text Explanation");
  ...
  fdui->ds_audio = obj = fl_add_pixmapbutton(FL_NORMAL_BUTTON,715,10,30,30,"Audio Explanation");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,explaudioCB,0);
    fl_set_pixmapbutton_data(obj,speaker);
  fl_end_form();
