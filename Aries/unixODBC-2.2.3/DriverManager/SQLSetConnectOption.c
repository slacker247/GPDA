 ...
 **********************************************************************
 *
 * $Id: SQLSetConnectOption.c,v 1.7 2002/07/25 09:30:26 lurcher Exp $
 *
...
static char const rcsid[]= "$RCSfile: SQLSetConnectOption.c,v $ $Revision: 1.7 $";
           ...
           SQLULEN value )
{
    ...
    value = (SQLINTEGER) __attr_override( connection, SQL_HANDLE_DBC, option, (void*) value, NULL );
