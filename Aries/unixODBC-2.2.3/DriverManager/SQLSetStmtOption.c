 ...
 **********************************************************************
 *
 * $Id: SQLSetStmtOption.c,v 1.2 2001/12/13 13:00:32 lurcher Exp $
 *
...
static char const rcsid[]= "$RCSfile: SQLSetStmtOption.c,v $ $Revision: 1.2 $";
           ...
           SQLROWCOUNT value )
{
    ...
    value = (SQLUINTEGER) __attr_override( statement, SQL_HANDLE_STMT, option, (void*) value, NULL );
