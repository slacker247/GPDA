/*
 File:		AcknowledgeFlagField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
 ...
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.AcknowledgeFlagField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/a4.htm">Acknowledge Flag Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/a4.htm">Acknowledge Flag Field</A> (SISO)
 ...
 *  You access this via something like <b><code>AcknowledgeFlagField.STOPFREEZE</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/AcknowledgeFlagField.java"><i>AcknowledgeFlagField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/AcknowledgeFlagField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/AcknowledgeFlagField.java</i></a>
 *
 */
public class AcknowledgeFlagField_2 extends Object
{
/**
 *(1) Create Entity
 */
public static final short CREATEENTITY = 1;

/**
 *(2) Remove entity
 */
public static final short REMOVEENTITY = 2;

/**
 *(3) Start/Resume
 */
public static final short STARTRESUME = 3;

/**
 *(4) Stop/Freeze
 */
public static final short STOPFREEZE = 4;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>AcknowledgeFlagField.toString (1)</code></b> returns the string "<b><code>CREATEENTITY</code></b>"
 */

public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 1: return "Create Entity"; 
		case 2: return "Remove entity"; 
		case 3: return "Start/Resume"; 
		case 4: return "Stop/Freeze"; 
		default : return "";
	}
}//end of toString
}//End of class 
