...
/***************************************************************/
globle BOOLEAN FactPNGetVar1(theValue,returnValue)
  VOID *theValue;
...
/**************************************************/
globle BOOLEAN FactPNGetVar2(theValue,returnValue)
  VOID *theValue;
  DATA_OBJECT_PTR returnValue;
  {
   struct fact *factPtr;
...
/*****************************************************************/
globle BOOLEAN FactPNGetVar3(theValue,returnValue)
  VOID *theValue;
  DATA_OBJECT_PTR returnValue;
  {
   struct fact *factPtr;
...
globle BOOLEAN FactFuzzyValuePNFunction(theValuePosition, returnValue)
  ...
  DATA_OBJECT_PTR returnValue;
  {
   ...
   fieldPtr = &CurrentPatternFact->theProposition.theFields[thePosition];
   ...
   if (fuzzyValueOfPatternPtr != NULL)
     ...
     { if ((FuzzyAlphaValue == 0.0) &&
       ...
       if (FuzzyAlphaValue == 0.0)
         {
           if (max_of_min(fuzzyValueOfPatternPtr, fuzzyValueOfFactPtr) == 0.0)
                return(CLIPS_FALSE);
         }
       else 
         {
           if (max_of_min(fuzzyValueOfPatternPtr, fuzzyValueOfFactPtr) < FuzzyAlphaValue)
                return(CLIPS_FALSE);
         }
     }
...
#pragma argsused
#endif
globle BOOLEAN FactPNConstant1(theValue,returnValue)
  VOID *theValue;
  DATA_OBJECT_PTR returnValue;
  {
...
#pragma argsused
#endif
globle BOOLEAN FactPNConstant2(theValue,returnValue)
  VOID *theValue;
  DATA_OBJECT_PTR returnValue;
  {
#if MAC_MPW || MAC_MCW  /* added 03-07-96 */
...
/**************************************************************/
globle BOOLEAN FactJNGetVar1(theValue,returnValue)
  VOID *theValue;
  DATA_OBJECT_PTR returnValue;
  {
   int theField, theSlot;
...
/*   extracted is from a single field slot.      */
/*************************************************/
globle BOOLEAN FactJNGetVar2(theValue,returnValue)
  VOID *theValue;
  DATA_OBJECT_PTR returnValue;
  {
   struct fact *factPtr;
...
/*   slot that contains at most one multifield variable.        */
/****************************************************************/
globle BOOLEAN FactJNGetVar3(theValue,returnValue)
  VOID *theValue;
  DATA_OBJECT_PTR returnValue;
  {
   struct fact *factPtr;
...
/****************************************************/
globle BOOLEAN FactSlotLength(theValue,returnValue)
  VOID *theValue;
  DATA_OBJECT_PTR returnValue;
  {   
   ...
   if ((unsigned int)segmentPtr->multifieldLength < (hack->minLength + extraOffset)) 
     { return(CLIPS_FALSE); }
   
   if (hack->exactly && ((unsigned int)segmentPtr->multifieldLength > (hack->minLength + extraOffset)))
     { return(CLIPS_FALSE); }
...
#pragma argsused
#endif
globle int FactJNCompVars1(theValue,theResult)
  VOID *theValue;
...
#pragma argsused
#endif
globle int FactJNCompVars2(theValue,theResult)
  VOID *theValue;
  DATA_OBJECT *theResult;
  {
#if MAC_MPW || MAC_MCW   /* added 03-07-96 */
...
/*****************************************************/
globle int FactPNCompVars1(theValue,theResult)
  VOID *theValue;
  DATA_OBJECT *theResult;
  {
   int rv;
...
#pragma argsused
#endif
globle int FactStoreMultifield(theValue,theResult)
  VOID *theValue;
  DATA_OBJECT *theResult;
  {  
#if MAC_MPW || MAC_MCW   /* added 03-07-96 */
