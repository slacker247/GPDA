/*
 File:		EntityFlamingEffectField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Entity Flaming Effect Field -- Describes whether flames are rising from an entity
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityFlamingEffectField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/45.htm">Entity Flaming Effect Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/45.htm">Entity Flaming Effect Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityFlamingEffectField.FLAMESPRESENT</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityFlamingEffectField.java"><i>EntityFlamingEffectField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityFlamingEffectField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityFlamingEffectField.java</i></a>
 *
 */
public class EntityFlamingEffectField_1 extends Object
{
/**
 *(0) None
 */
 ...
 *(1) Flames present
 */
public static final short FLAMESPRESENT = 1;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>EntityFlamingEffectField.toString (0)</code></b> returns the string "<b><code>NONE</code></b>"
 */
