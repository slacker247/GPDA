/*
 File:		EntityCapabilitiesAmunitionSupplyField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Entity Capabilities Amunition Supply Field -- The Entity is able to supply some type of ammunition in response to an appropriate Service Request PDU.
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityCapabilitiesAmunitionSupplyField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/68.htm">Entity Capabilities Amunition Supply Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/68.htm">Entity Capabilities Amunition Supply Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityCapabilitiesAmunitionSupplyField.TRUE</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityCapabilitiesAmunitionSupplyField.java"><i>EntityCapabilitiesAmunitionSupplyField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityCapabilitiesAmunitionSupplyField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityCapabilitiesAmunitionSupplyField.java</i></a>
 *
 */
public class EntityCapabilitiesAmunitionSupplyField_1 extends Object
{
/**
 *(0) False
 */
 ...
 * as in <b><code>EntityCapabilitiesAmunitionSupplyField.toString (0)</code></b> returns the string "<b><code>FALSE</code></b>"
 */
