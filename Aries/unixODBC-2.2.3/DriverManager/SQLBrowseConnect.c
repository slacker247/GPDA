 ...
 **********************************************************************
 *
 * $Id: SQLBrowseConnect.c,v 1.7 2002/08/15 08:10:33 lurcher Exp $
 *
...
static char const rcsid[]= "$RCSfile: SQLBrowseConnect.c,v $ $Revision: 1.7 $";
