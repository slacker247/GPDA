/*
 File:		StateUpdateIndicatorField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * State Update Indicator Field -- This field shall be used to indicate if the data in the PDU represents a state update or just data that has changed since issuance of the last Emitter PDU (relative to the identified entity and emission system(s)). This field shall be represented by an 8-bit enumeration. (see Section 8 in EBV-DOC).
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.StateUpdateIndicatorField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/b7.htm">State Update Indicator Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/b7.htm">State Update Indicator Field</A> (SISO)
 ...
 *  You access this via something like <b><code>StateUpdateIndicatorField.CHANGEDDATAUPDATE</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/StateUpdateIndicatorField.java"><i>StateUpdateIndicatorField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/StateUpdateIndicatorField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/StateUpdateIndicatorField.java</i></a>
 *
 */
public class StateUpdateIndicatorField_1 extends Object
{
/**
 *(0) State Update
 */
public static final short STATEUPDATE = 0;

/**
 *(1) Changed Data Update
 */
public static final short CHANGEDDATAUPDATE = 1;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>StateUpdateIndicatorField.toString (0)</code></b> returns the string "<b><code>STATEUPDATE</code></b>"
 */

public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "State Update"; 
		case 1: return "Changed Data Update"; 
		default : return "";
	}
}//end of toString
}//End of class 
