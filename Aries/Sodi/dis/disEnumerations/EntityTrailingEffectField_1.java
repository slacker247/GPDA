/*
 File:		EntityTrailingEffectField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Entity Trailing Effect Field -- Describes the size of trailing effects from an entity.  Trailing effects include dust clouds for land platforms, wakes for surface platforms, rocket flames for guided munitions, contrails and ionization trails for air paltforms, etc.
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityTrailingEffectField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/42.htm">Entity Trailing Effect Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/42.htm">Entity Trailing Effect Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityTrailingEffectField.LARGE</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityTrailingEffectField.java"><i>EntityTrailingEffectField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityTrailingEffectField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityTrailingEffectField.java</i></a>
 *
 */
public class EntityTrailingEffectField_1 extends Object
{
/**
 *(0) None
 */
 ...
 *(3) Large
 */
public static final short LARGE = 3;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>EntityTrailingEffectField.toString (0)</code></b> returns the string "<b><code>NONE</code></b>"
 */
