	...
	implements java.sql.Connection
{
		...
		throws Exception
	{
        ...
        public java.sql.Statement createStatement(int i, int x)
        {return null;}
        
        public java.sql.PreparedStatement prepareStatement(String s, int i, int x)
        {return null;}
        
        public java.sql.CallableStatement prepareCall(String s, int i, int x)
        {return null;}
        ...
        public java.sql.Statement createStatement(int i, int x, int y)
        {return null;}
        
        public java.sql.PreparedStatement prepareStatement(String s, int i, int x, int y)
        {return null;}
        
        public java.sql.CallableStatement prepareCall(String s, int i, int x, int y)
        {return null;}
        ...
        public java.sql.PreparedStatement prepareStatement(String s, String[] i)
        {return null;}
}
