...
globle VOID InitializeFactPatterns()
  {
   ...
   AddPatternParser("facts",0,&FactInfo,
                    ...
                    MarkFactPatternForIncrementalReset,
...
static struct patternNodeHeader *PlaceFactPattern(thePattern)
  struct lhsParseNode *thePattern;
  {
   ...
   int endSlot, count;
   char *deftemplateName; /* changed 03-06-96 */
...
/***********************************************************/
static VOID FindAndSetDeftemplatePatternNetwork(rootNode,newRootNode)
...
static VOID ClearPatternMatches(patternPtr)
  struct factPatternNode *patternPtr;
  {
   ...
   struct patternMatch *lastMatch, *theMatch; /* changed 03-06-96 */
