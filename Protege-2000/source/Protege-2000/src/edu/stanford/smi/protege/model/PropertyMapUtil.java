...
public class PropertyMapUtil {
    ...
    private static Entry getEntry(Object value) {
        ...
        if (value instanceof Frame) {
            ...
            if (frame.isValid()) {
                ...
                Log.trace("discarding entry for deleted frame", PropertyMapUtil.class, "getEntry");
            }
    ...
    private static Object getJavaClassObject(String className, String value) {
        Object result = null;
        Class c = SystemUtilities.forName(className);
        if (c == null) {
            Log.warning("Unable to load class", PropertyMapUtil.class, "getJavaClassObject", className, value);
        } else {
            try {
                java.lang.reflect.Constructor constructor = c.getConstructor(new Class[] { String.class });
                if (constructor == null) {
                    Log.warning("Class has no string constructor", PropertyMapUtil.class, "getJavaClassObject", className, value);
                } else {
