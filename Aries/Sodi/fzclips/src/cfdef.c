  ...
  struct partialMatch *binds;
{
   ...
   */
   ...
   for (i=0; i<(unsigned int)binds->bcount; i++)
     {
               ...
               if (patternNum == i) 
                  {
                    ...
                    fact_cf = similarity(antecedent_fv,fact_fv) * theFactCF;
