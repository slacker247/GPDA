...
#include "reorder.h"
   ...
   static struct lhsParseNode    *CompressCEs(struct lhsParseNode *,int *);     /* added 03-12-96 */
      ...
      switch (theNode->type)
        {
         ...
         default:
           PrintCLIPS(fileid,"(?!!)"); /* to avoid trigraph sequence */
           break;                      /* changed 03-12-96 */
