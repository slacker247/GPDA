 ...
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityAppearancePlatformPowerPlantStatusField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/49.htm">Entity Appearance Platform Power-Plant Status Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/49.htm">Entity Appearance Platform Power-Plant Status Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityAppearancePlatformPowerPlantStatusField.POWERPLANTON</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityAppearancePlatformPowerPlantStatusField.java"><i>EntityAppearancePlatformPowerPlantStatusField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearancePlatformPowerPlantStatusField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearancePlatformPowerPlantStatusField.java</i></a>
 *
 */
public class EntityAppearancePlatformPowerPlantStatusField_1 extends Object
{
/**
 *(0) Power Plant Off
 */
public static final short POWERPLANTOFF = 0;

/**
 *(1) Power Plant On
 */
public static final short POWERPLANTON = 1;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>EntityAppearancePlatformPowerPlantStatusField.toString (0)</code></b> returns the string "<b><code>POWERPLANTOFF</code></b>"
 */

public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "Power Plant Off"; 
		case 1: return "Power Plant On"; 
		default : return "";
	}
}//end of toString
}//End of class 
