...
/***************************************/
   ...
   static long                              NumberOfPatternFuzzyValues;
#endif
...
#if FUZZY_DEFTEMPLATES    /* added 03-12-96 */
   static struct fzSlotLocator HUGE_ADDR   *PatternFuzzyValueArray;
#endif
...
/***************************************/
   ...
   static VOID                    BsaveJoin(FILE *,struct joinNode *);                               /* added 03-12-96 */
   static VOID                    BsaveDisjuncts(FILE *,struct defrule *);                       /* added 03-12-96 */
#endif
...
#if FUZZY_DEFTEMPLATES    /* added 03-12-96 */
   static VOID                    UpdatePatternFuzzyValues(VOID *,long);
#endif
                ...
                for (i= 0; i<theDisjunct->numberOfFuzzySlots; i++)
                   {
                     ...
                     if (fvhnPtr != NULL)
                       { fvhnPtr->neededFuzzyValue = CLIPS_TRUE;
                       }
                   }
              }
#endif
...
#pragma unused(obji)
    ...
    */
    ...
    PatternFuzzyValueArray[obji].patternNum = bFSL->patternNum;
    PatternFuzzyValueArray[obji].slotNum = bFSL->slotNum;
    PatternFuzzyValueArray[obji].fvhnPtr = FuzzyValueArray[bFSL->fvhnPtr];
  }
#endif
