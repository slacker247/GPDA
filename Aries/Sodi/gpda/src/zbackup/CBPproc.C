...
int             i;
   ...
   if(!fl_form_is_visible(fd_cbpinput->cbpinput) ) {
	...
	fl_addto_menu(fd_cbpinput->jcs_orders, "JCS-Order-1437.5");
   }
...
char            cmdline[2400];
   ...
   switch (item) {
     case 0: // Process JCS Menu 
       ...
       sprintf(filename, "CBPkeys.%s", getenv("GPDADOMAIN"));
     ...
     case 5: // Search Cases
	  ...
	  n_matches = 3;
	  strcpy(CaseName[0], "JCS-Order-1014.4"); CaseMatch[0] = 92;
	  strcpy(CaseName[1], "JCS-Order-1258.2"); CaseMatch[1] = 86;
	  strcpy(CaseName[2], "JCS-Order-1411.8"); CaseMatch[2] = 73;
       }
       //
