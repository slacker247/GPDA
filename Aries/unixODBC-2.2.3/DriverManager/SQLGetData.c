 ...
 **********************************************************************
 *
 * $Id: SQLGetData.c,v 1.8 2002/08/23 09:42:37 lurcher Exp $
 *
 * $Log: SQLGetData.c,v $
...
static char const rcsid[]= "$RCSfile: SQLGetData.c,v $ $Revision: 1.8 $";
           ...
           SQLLEN *strlen_or_ind )
{
    ...
    else if ( SQL_SUCCEEDED( ret ) && unicode_switch )
    {
        ...
        {
            ansi_to_unicode_copy( target_value, (char*) as1, ind_value, statement -> connection );
        }
