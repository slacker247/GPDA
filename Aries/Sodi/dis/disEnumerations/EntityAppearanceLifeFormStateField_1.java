/*
 File:		EntityAppearanceLifeFormStateField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Entity Appearance LifeForm State Field -- Describes the State of the Lifeform.
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityAppearanceLifeFormStateField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/5d.htm">Entity Appearance LifeForm State Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/5d.htm">Entity Appearance LifeForm State Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityAppearanceLifeFormStateField.JUMPING</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityAppearanceLifeFormStateField.java"><i>EntityAppearanceLifeFormStateField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearanceLifeFormStateField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearanceLifeFormStateField.java</i></a>
 *
 */
public class EntityAppearanceLifeFormStateField_1 extends Object
{
/**
 *(0) Null
 */
 ...
 */
public static final short UPRIGHTSTANDINGSTILL = 1;

/**
 *(2) Upright, walking
 */
public static final short UPRIGHTWALKING = 2;

/**
 *(3) Upright, running
 */
public static final short UPRIGHTRUNNING = 3;

/**
 *(4) Kneeling
 */
public static final short KNEELING = 4;

/**
 *(5) Prone
 */
public static final short PRONE = 5;

/**
 *(6) Crawling
 */
public static final short CRAWLING = 6;

/**
 *(7) Swimming
 */
public static final short SWIMMING = 7;

/**
 *(8) Parachuting
 */
public static final short PARACHUTING = 8;

/**
 *(9) Jumping
 */
public static final short JUMPING = 9;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>EntityAppearanceLifeFormStateField.toString (0)</code></b> returns the string "<b><code>NULL</code></b>"
 */
...
public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "Null"; 
		case 1: return "Upright, standing still"; 
		case 2: return "Upright, walking"; 
		case 3: return "Upright, running"; 
