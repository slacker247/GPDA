...
/**
 * System field -- This field shall specify the interpretation of the modulation parameter field(s) in the Transmitter PDU. This field shall be represented by a 16-bit enumeration (see Section 9 in EBV-DOC).
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.Systemfield feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/f0.htm">System field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/f0.htm">System field</A> (SISO)
 ...
 *  You access this via something like <b><code>Systemfield.CCTTSINCGARS</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/Systemfield.java"><i>Systemfield.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/Systemfield.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/Systemfield.java</i></a>
 *
 */
public class Systemfield_2 extends Object
{
/**
 *(0) Other
 */
 ...
 *(6) CCTT SINCGARS
 */
public static final short CCTTSINCGARS = 6;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>Systemfield.toString (0)</code></b> returns the string "<b><code>OTHER</code></b>"
 */
