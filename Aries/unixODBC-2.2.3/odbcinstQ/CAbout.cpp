...
CAbout::CAbout( QWidget* parent, const char* name )
	: QWidget( parent, name )
{
    // LINES
	...
	qtarch_Label_2 = new QLabel( qtarch_Frame_2, "Label_2" );
	qtarch_Label_2->setGeometry( 5, 5, 32, 32 );
    qtarch_Label_2->setPixmap( info_xpm );

	qtarch_Label_1 = new QLabel( qtarch_Frame_2, "Label_1" );
	qtarch_Label_1->setGeometry( 60, 5, qtarch_Frame_2->width() - 70, qtarch_Frame_2->height() - 10 );
...
void CAbout::pbODBCConfig_Clicked()
{
    QString qsMsg;
...
void CAbout::pbDatabase_Clicked()
{
    QString qsMsg;
...
void CAbout::pbDriverManager_Clicked()
{
    QString qsMsg;
...
void CAbout::pbODBCDrivers_Clicked()
{
    QString qsMsg;
...
{
    CCredits *credits = new CCredits( this );
    credits->exec();

    return;
}

void CAbout::pbApplication_Clicked()
{
    QString qsMsg;
