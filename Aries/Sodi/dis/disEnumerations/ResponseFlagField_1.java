...
/**
 * Response Flag Field -- This field shall indicate whether or not the receiving entity was able to comply with the request, and for what reason. This field shall be represented by a 16-bit enumeration (see Section 7 in EBV-DOC).
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.ResponseFlagField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/a5.htm">Response Flag Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/a5.htm">Response Flag Field</A> (SISO)
 ...
 *  You access this via something like <b><code>ResponseFlagField.UNABLETOCOMPLY</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/ResponseFlagField.java"><i>ResponseFlagField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/ResponseFlagField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/ResponseFlagField.java</i></a>
 *
 */
public class ResponseFlagField_1 extends Object
{
/**
 *(0) Other
 */
 ...
 *(1) Able to comply
 */
public static final short ABLETOCOMPLY = 1;

/**
 *(2) Unable to comply
 */
public static final short UNABLETOCOMPLY = 2;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>ResponseFlagField.toString (0)</code></b> returns the string "<b><code>OTHER</code></b>"
 */
