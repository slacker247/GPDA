...
#include "tmpltpsr.h"
#include "tmpltrhs.h"
#include "tmpltutl.h"     /* added 03-07-96 */
#include "exprnpsr.h"
#include "strngrtr.h"
#include "router.h"
...
#if CERTAINTY_FACTORS || FUZZY_DEFTEMPLATES    /* added 03-07-96 */
#include "fuzzyrhs.h"
#endif
	      ...
	      ((strcmp(ValueToString(tempToken->value),"CF") == 0) ||
	       (strcmp(ValueToString(tempToken->value),"cf") == 0))
             )
            {
              ...
              GetToken(readSource,tempToken); 
              CFexpr = 
tokenToFloatExpression(readSource,tempToken,error,constantsOnly);
             ...
             /* store the CF expression in the argList of the
DEFTEMPLATE_PTR expr */
