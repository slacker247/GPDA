...
C_BASETYPE *sensor_names, *sensor_name;
...
XmString xstr;
  ...
  sprintf (str, " %s%s\n %s%d\n %s%d\n %s%f\n %s%d\n %s%f%s\n %s%f%s\n %s%s\n", 
                ...
                "SPEEDES Object Id:     ", 1047,
                "Probability of Kill:   ", gbipkill,
                "No. of Interceptors:   ", gbingbis[gbiselect],
                "Latitude of Farm:      ", gbilatit[gbiselect], "N",
                "Longitude of Farm:     ", gbilongi[gbiselect], "E",
...
XmString xstr;
  ...
  sprintf (str, " %s%s\n %s%d\n %s%d\n %s%d\n %s%f%s\n %s%f%s\n %s%s\n", 
                ...
                "SPEEDES Object Id:     ", 2047,
                "No. of Interceptors:   ", 35,
                "Latitude of Site:      ", gbrlatit[gbrselect], "N",
                "Longitude of Site:     ", gbrlongi[gbrselect], "E",
                "Operational Status:    ", "GREEN");
  xstr = XmStringCreateLtoR(str, XmSTRING_DEFAULT_CHARSET);
  XtSetArg (arg[0], XmNmessageString, xstr);
