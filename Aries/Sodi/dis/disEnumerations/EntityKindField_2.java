 ...
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityKindField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/22.htm">Entity Kind Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/22.htm">Entity Kind Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityKindField.SENSOREMITTER</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityKindField.java"><i>EntityKindField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityKindField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityKindField.java</i></a>
 *
 */
public class EntityKindField_2 extends Object
{
/**
 *(0) Other
 */
 ...
 *(5) Cultural feature
 */
public static final short CULTURALFEATURE = 5;
 ...
 *(9) Sensor/Emitter
 */
public static final short SENSOREMITTER = 9;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>EntityKindField.toString (0)</code></b> returns the string "<b><code>OTHER</code></b>"
 */
