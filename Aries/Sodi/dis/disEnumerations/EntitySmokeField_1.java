...
/**
 * Entity Smoke Field -- Describes status or location of smoke emanating from an entity
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntitySmokeField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/40.htm">Entity Smoke Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/40.htm">Entity Smoke Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntitySmokeField.ENTITYISEMITTINGENGINESMOKEANDSMOKEPLUMEISRSINGFROMTHEENTITY</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntitySmokeField.java"><i>EntitySmokeField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntitySmokeField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntitySmokeField.java</i></a>
 *
 */
public class EntitySmokeField_1 extends Object
{
/**
 *(0) Not Smoking
 */
public static final short NOTSMOKING = 0;

/**
 *(1) Smoke plume is rising from the entity
 */
public static final short SMOKEPLUMEISRISINGFROMTHEENTITY = 1;

/**
 *(2) Entity is emitting engine smoke
 */
public static final short ENTITYISEMITTINGENGINESMOKE = 2;

/**
 *(3) Entity is emitting engine smoke and smoke plume is rsing from the entity
 */
public static final short ENTITYISEMITTINGENGINESMOKEANDSMOKEPLUMEISRSINGFROMTHEENTITY = 3;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>EntitySmokeField.toString (0)</code></b> returns the string "<b><code>NOTSMOKING</code></b>"
 */

public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "Not Smoking"; 
		case 1: return "Smoke plume is rising from the entity"; 
		case 2: return "Entity is emitting engine smoke"; 
		case 3: return "Entity is emitting engine smoke and smoke plume is rsing from the entity"; 
		default : return "";
	}
}//end of toString
}//End of class 
