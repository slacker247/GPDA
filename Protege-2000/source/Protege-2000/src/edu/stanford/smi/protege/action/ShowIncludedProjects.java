...
public class ShowIncludedProjects extends ProjectAction {
    ...
    public ShowIncludedProjects() {
        super("Show Included Projects...", Icons.getBlankIcon());
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (project != null) {
            ModalDialog.showDialog(parent, new IncludedProjectsPanel(project), "Included Projects", ModalDialog.MODE_CLOSE);
        }
    }
}
