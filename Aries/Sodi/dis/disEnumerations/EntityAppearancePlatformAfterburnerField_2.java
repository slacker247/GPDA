/*
 File:		EntityAppearancePlatformAfterburnerField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Entity Appearance Platform Afterburner Field -- Describes the status of an air platform's afterburner
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityAppearancePlatformAfterburnerField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/55.htm">Entity Appearance Platform Afterburner Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/55.htm">Entity Appearance Platform Afterburner Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityAppearancePlatformAfterburnerField.AFTERBURNERON</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityAppearancePlatformAfterburnerField.java"><i>EntityAppearancePlatformAfterburnerField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearancePlatformAfterburnerField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearancePlatformAfterburnerField.java</i></a>
 *
 */
public class EntityAppearancePlatformAfterburnerField_2 extends Object
{
/**
 *(0) Afterburner Not On
 */
public static final short AFTERBURNERNOTON = 0;

/**
 *(1) Afterburner On
 */
public static final short AFTERBURNERON = 1;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>EntityAppearancePlatformAfterburnerField.toString (0)</code></b> returns the string "<b><code>AFTERBURNERNOTON</code></b>"
 */

public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "Afterburner Not On"; 
		case 1: return "Afterburner On"; 
		default : return "";
	}
}//end of toString
}//End of class 
