/*
 File:		EntityAppearancePlatformConcealedField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Entity Appearance Platform Concealed Field -- Describes the type of concealment
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityAppearancePlatformConcealedField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/4d.htm">Entity Appearance Platform Concealed Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/4d.htm">Entity Appearance Platform Concealed Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityAppearancePlatformConcealedField.ENTITYINAPREPAREDCONCEALEDPOSITION</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityAppearancePlatformConcealedField.java"><i>EntityAppearancePlatformConcealedField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearancePlatformConcealedField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearancePlatformConcealedField.java</i></a>
 *
 */
public class EntityAppearancePlatformConcealedField_1 extends Object
{
/**
 *(0) Not Concealed
 */
public static final short NOTCONCEALED = 0;

/**
 *(1) Entity in a prepared concealed position (with netting, etc)
 */
public static final short ENTITYINAPREPAREDCONCEALEDPOSITION = 1;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>EntityAppearancePlatformConcealedField.toString (0)</code></b> returns the string "<b><code>NOTCONCEALED</code></b>"
 */

public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "Not Concealed"; 
		case 1: return "Entity in a prepared concealed position (with netting, etc)"; 
		default : return "";
	}
}//end of toString
}//End of class 
