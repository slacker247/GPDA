/*
 File:		ModulationParameterfield.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Modulation Parameter field -- This field shall specify modulation type (see 5.4.8.1(m)) specific characteristics of the radio transmission. The interpretation of this field shall depend on the value of the System field of the Modulation Type record (see 5.3.23). The interpretation of this field for each value of the System field is specified in Section 9 EBV-DOC.
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.ModulationParameterfield feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/f6.htm">Modulation Parameter field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/f6.htm">Modulation Parameter field</A> (SISO)
 ...
 *  You access this via something like <b><code>ModulationParameterfield.SINCGARS</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/ModulationParameterfield.java"><i>ModulationParameterfield.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/ModulationParameterfield.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/ModulationParameterfield.java</i></a>
 *
 */
public class ModulationParameterfield_2 extends Object
{
/**
 *(0) Other
 */
 ...
 *(2) HQ
 */
public static final short HQ = 2;

/**
 *(3) HQII
 */
public static final short HQII = 3;

/**
 *(4) HQIIA
 */
public static final short HQIIA = 4;

/**
 *(5) SINCGARS
 */
public static final short SINCGARS = 5;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>ModulationParameterfield.toString (0)</code></b> returns the string "<b><code>OTHER</code></b>"
 */
