 ...
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.SpreadSpectrumfield feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/ed.htm">Spread Spectrum field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/ed.htm">Spread Spectrum field</A> (SISO)
 ...
 *  You access this via something like <b><code>SpreadSpectrumfield.TIMEHOPPING</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/SpreadSpectrumfield.java"><i>SpreadSpectrumfield.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/SpreadSpectrumfield.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/SpreadSpectrumfield.java</i></a>
 *
 */
public class SpreadSpectrumfield_1 extends Object
{
/**
 *(0) Frequency Hopping
 */
public static final short FREQUENCYHOPPING = 0;

/**
 *(1) Pseudo-noise
 */
public static final short PSEUDONOISE = 1;

/**
 *(2) Time Hopping
 */
public static final short TIMEHOPPING = 2;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>SpreadSpectrumfield.toString (0)</code></b> returns the string "<b><code>FREQUENCYHOPPING</code></b>"
 */

public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "Frequency Hopping"; 
		case 1: return "Pseudo-noise"; 
		case 2: return "Time Hopping"; 
		default : return "";
	}
}//end of toString
}//End of class 
