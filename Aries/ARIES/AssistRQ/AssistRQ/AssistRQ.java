...
public class AssistRQ extends javax.swing.JFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        OKBTN_NewNode.setBounds(20, 70, 51, 26);
        ...
        ExportDiag_OkBtn.setBounds(20, 130, 50, 26);
        ...
        ExportDiag_CancelBtn.setBounds(100, 130, 73, 26);
        ...
        ConfigHost_CancelBTN.setBounds(290, 230, 73, 20);
        ...
        jLabel9.setBounds(310, 120, 66, 16);
        ...
        jRadioBtnLocal.setBounds(50, 310, 85, 24);
        ...
        jBTN_OK_RQ_Form.setBounds(490, 640, 51, 26);
        ...
        jBTN_Cancel_RQ_Form.setBounds(630, 640, 73, 26);
        ...
        jBTN_Exit_RQ_Form.setBounds(710, 640, 55, 26);
        ...
        RQ_FormBTN.setBounds(540, 270, 83, 26);
    ...
    /**
     * This method inserts data into the XML file for passing
     * to the attention queuer.  In the interest of time, the
     * values are more or less hard coded for specific label-
     * value pairs.  In the future, these might be implemented
     * by rules.
     *
     * @param file the FileWriter corresponding to the output file
     * @param record the RQ values
     */
    private void insertData(FileWriter file, String record) {
        // get the labels
        String[] labels = Form_RQ.getLabelValues();
        ...
        try {
            ...
            while(st.hasMoreTokens() && j < values.length) {
        ...
        // convert belief so comparisons are possible
        float belief = (new Float(values[2])).floatValue();
        
        // prepared date
        String date = values[49].replace('_', ' ');
        
        // arbitrary location
        String Y = (new Long(Math.round(Math.random() * 100.0f) + 50)).toString();
        String X = (new Long(Math.round(Math.random() * 100.0f) + 50)).toString();
        ...
        // Name the bubble
        // "subject"
        String name = values[28].replace('_', ' ');
        
        try {
        
            file.write("\n\t<aq-task>\n\n\t\t<aq-taskname></aq-taskname>\n" +
                            "\t\t<aq-tasknotes></aq-tasknotes>\n" +
                            "\t\t<aq-taskstate>\n" +
                            "\t\t<aq-taskstate-time>" + date + "</aq-taskstate-time>\n" +
                            "\t\t<aq-taskstate-properties>\n\n");
        
            file.write("\t\t<aq-property>\n" +
                            "\t\t\t<aq-property-name>y</aq-property-name>\n" +
                            "\t\t\t<aq-property-value>" + Y + "</aq-property-value>\n" +
                            "\t\t</aq-property>\n\n");
        
            file.write("\t\t<aq-property>\n" +
                            "\t\t\t<aq-property-name>x</aq-property-name>\n" +
                            "\t\t\t<aq-property-value>" + X + "</aq-property-value>\n" +
                            "\t\t</aq-property>\n\n");

            file.write("\t\t<aq-property>\n" +
                            "\t\t\t<aq-property-name>urgency</aq-property-name>\n" +
                            "\t\t\t<aq-property-value>" + urgency + "</aq-property-value>\n" + 
                            "\t\t</aq-property>\n\n");
        
            file.write("\t\t<aq-property>\n" +
                            "\t\t\t<aq-property-name>importance</aq-property-name>\n" +
                            "\t\t\t<aq-property-value>" + importance + "</aq-property-value>\n" + 
                            "\t\t</aq-property>\n\n");
        
            file.write("\t\t<aq-property>\n" +
                            "\t\t\t<aq-property-name>effort</aq-property-name>\n" +
                            "\t\t\t<aq-property-value>" + effort + "</aq-property-value>\n" + 
                            "\t\t</aq-property>\n\n");
        
            file.write("\t\t<aq-property>\n" +
                            "\t\t\t<aq-property-name>deceased</aq-property-name>\n" +
                            "\t\t\t<aq-property-value>false</aq-property-value>\n" + 
                            "\t\t</aq-property>\n\n");
        
            file.write("\t\t<aq-property>\n" +
                            "\t\t\t<aq-property-name>category</aq-property-name>\n" +
                            "\t\t\t<aq-property-value>" + category + "</aq-property-value>\n" + 
                            "\t\t</aq-property>\n\n");
        
            file.write("\t\t<aq-property>\n" +
                            "\t\t\t<aq-property-name>notes</aq-property-name>\n" +
                            "\t\t\t<aq-property-value></aq-property-value>\n" + 
                            "\t\t</aq-property>\n\n");
        
            file.write("\t\t<aq-property>\n" +
                            "\t\t\t<aq-property-name>name</aq-property-name>\n" +
                            "\t\t\t<aq-property-value>" + name + "</aq-property-value>\n" + 
                            "\t\t</aq-property>\n\n");
        
            file.write("\t\t</aq-taskstate-properties>\n" + 
                            "\t\t</aq-taskstate>\n" +
                            "\t</aq-task>\n\n");
    ...
    /*
     * This method exports evidence in a format suitable for the 
     * Attention Cuer.  That is, it parses the XML file, inserts
     * the pertinent new information, and outputs it all back
     * into the XML file.
     */
    private void exportToAC(String record) {
        ...
        /* prefix is all the information before the insertion point
         * postfix is all the information after the insertion point
         *
         ...
         * postfix
         *
         * This allows all the original data in the file to be retained.
         */
        ...
        try {
            input = new FileReader(new File("output.aqg"));
            ...
            /* while we are still parsing the prefix
             *
             * The prefix is terminated with the tag
             * <aq-tasklist>
             */            
            while(isPrefix) {
                temp = (char)(input.read());
                
                // "<" could signal the end of the prefix
                while(temp != '<') {
                    // if the buffer has been filled
                    if(index == bufferSize-2) {
                        buffer[index] = temp;
                        buffer[index+1] = '\0';
                        prefix += ((new String(buffer)).trim());
                        index = 0;
                    } else {
                        buffer[index] = temp;
                        index++;
            ...
            while(tempChar != -1) {
                if(index == bufferSize-2) {
                    buffer[index] = (char)(tempChar);
                    buffer[index+1] = '\0';
                    postfix += ((new String(buffer)).trim());
                    index = 0;
                } else {
                    buffer[index] = (char)(tempChar);
                    index++;
            ...
            // get rid of the garbage at the end of the buffer
            ...
            output = new FileWriter(new File("output.aqg"));
            output.write(prefix);
            insertData(output, record);
    ...
    void writeConfigFile() throws IOException {
        ...
        if(Configuration != null) {
            ...
            oOutStream.write(Configuration.Password + "\n");
    ...
    void readConfigFile() throws Exception {
        ...
        if(Configuration != null) {
            ...
            Configuration.Password = br.readLine();
    ...
    private void ExportDiag_OkBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExportDiag_OkBtnActionPerformed
        //this preforms two things, the first is to save the file to a .tab then
        ...
        try {
             ...
             */
            if(Sodi1RadioBtn.isSelected())http://my.systems.trw.com/portal/page?_pageid=213,121793&_dad=portal&_schema=PORTAL
            {
             ...
             */
                ...
                try {
                    ...
                    Stmt = Conn.createStatement();
                    if(debug) System.out.println("Established a connection with DB: " + DBUrl);
                    //DBs = Stmt.executeUpdate("INSERT INTO Evidence VALUES (" + Record + ");");
                    Stmt.executeUpdate("INSERT INTO Evidence VALUES (" + Record + ");");
                }catch(Exception e) {
                    e.printStackTrace();
                } finally {
                    if (Stmt != null) {
    ...
    private void File_ProcessTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_File_ProcessTxtActionPerformed
        ...
        fileOpen.setCurrentDirectory(new File(WorkingDir + System.getProperty("file.separator") + "AssistRQ" + System.getProperty("file.separator") + "SampleTexts"));
        ...
        System.out.println("Opening file: " + CurrentTxtFile);
    ...
    public static void main(String args[]) {
        ...
        //Temp.exportToAC("This is a test");
    }
    ...
    private javax.swing.JCheckBoxMenuItem CBMenuMissions[] = new javax.swing.JCheckBoxMenuItem[15];
    ...
    void ConnectDB(String DB) {
        ...
        System.out.println(Configuration.Host);
