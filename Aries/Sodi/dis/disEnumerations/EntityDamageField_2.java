 ...
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityDamageField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/3f.htm">Entity Damage Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/3f.htm">Entity Damage Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityDamageField.DESTROYED</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityDamageField.java"><i>EntityDamageField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityDamageField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityDamageField.java</i></a>
 *
 */
public class EntityDamageField_2 extends Object
{
/**
 *(0) No Damage
 */
public static final short NODAMAGE = 0;

/**
 *(1) Slight Damage
 */
public static final short SLIGHTDAMAGE = 1;

/**
 *(2) Moderate Damage
 */
public static final short MODERATEDAMAGE = 2;
 ...
 * as in <b><code>EntityDamageField.toString (0)</code></b> returns the string "<b><code>NODAMAGE</code></b>"
 */

public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "No Damage"; 
		case 1: return "Slight Damage"; 
