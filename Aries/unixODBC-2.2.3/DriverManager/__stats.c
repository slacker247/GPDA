 ...
 **********************************************************************
 *
 * $Id: __stats.c,v 1.1.1.1 2001/10/17 16:40:09 lurcher Exp $
 *
 * $Log: __stats.c,v $
...
static char const rcsid[]= "$RCSfile: __stats.c,v $ $Revision: 1.1.1.1 $";
