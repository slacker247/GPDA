/** Header file generated with fdesign on Tue Apr 15 12:31:19 2003.**/

#ifndef FD_dsevedit_h_
#define FD_dsevedit_h_
...
typedef struct {
	...
	char *cdata;
	long  ldata;
	FL_OBJECT *story_canvas;
} FD_storyBUDs;

extern FD_storyBUDs * create_form_storyBUDs(void);

#endif /* FD_dsevedit_h_ */
