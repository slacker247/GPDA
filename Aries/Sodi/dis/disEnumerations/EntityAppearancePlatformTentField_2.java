/*
 File:		EntityAppearancePlatformTentField.java
 CVS Info:      $Id$
 Compiler:	jdk 1.2.2
 */
...
/**
 * Entity Appearance Platform Tent Field -- Describes the status of a platforms tent extension
 *@version 1.1
 *@author Ronan Fauglas
 *@author <a href="mailto:brutzman@nps.navy.mil?subject=dis-java-vrml: disEnumerations.EntityAppearancePlatformTentField feedback ">Don Brutzman</a>
 *
 *<dt><b>References:</b>
 *<dd>		DIS Data Dictionary: <A href="../../../../../../mil/navy/nps/disEnumerations/JdbeHtmlFiles/pdu/4e.htm">Entity Appearance Platform Tent Field</A> (local)
 *				     <A href="http://SISO.sc.ist.ucf.edu/dis/dis-dd/pdu/4e.htm">Entity Appearance Platform Tent Field</A> (SISO)
 ...
 *  You access this via something like <b><code>EntityAppearancePlatformTentField.EXTENDED</code></b>, i.e. combine
 ...
 *
 *<dt><b>Location:</b>
 *<dd><a href="../../../../../../mil/navy/nps/disEnumerations/EntityAppearancePlatformTentField.java"><i>EntityAppearancePlatformTentField.java</i></A> (local)
 *<dd><a href="http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearancePlatformTentField.java">
 *          <i>http://www.web3D.org/WorkingGroups/vrtp/mil/navy/nps/disEnumerations/EntityAppearancePlatformTentField.java</i></a>
 *
 */
public class EntityAppearancePlatformTentField_2 extends Object
{
/**
 *(0) Not Extended
 */
public static final short NOTEXTENDED = 0;

/**
 *(1) Extended
 */
public static final short EXTENDED = 1;

/**
 * Returns a string containing the enumeration name which corresponds to an enumeration value,
 * as in <b><code>EntityAppearancePlatformTentField.toString (0)</code></b> returns the string "<b><code>NOTEXTENDED</code></b>"
 */

public static String toString(int idNumber) 
{
	switch (idNumber) {
		case 0: return "Not Extended"; 
