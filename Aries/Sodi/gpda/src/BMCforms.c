...
FD_bmc3 *create_form_bmc3(void)
{
  ...
  fdui->bmc_alarmcount = obj = fl_add_input(FL_INT_INPUT,105,50,20,20,"");
    ...
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,BMCnoneCB,0);
  fdui->bmc_title = obj = fl_add_text(FL_NORMAL_TEXT,635,205,320,20,"General Purpose Decision Aids Testbed - 3.3");
    fl_set_object_color(obj,FL_LEFT_BCOL,FL_LEFT_BCOL);
    fl_set_object_lcolor(obj,FL_BLUE);
...
FD_statcomm *create_form_statcomm(void)
{
  ...
  fdui->statcomm = fl_bgn_form(FL_NO_BOX, 1001, 711);
  obj = fl_add_box(FL_FRAME_BOX,0,0,1001,711,"");
...
FD_statsubs *create_form_statsubs(void)
{
  ...
  fdui->subs_bm = obj = fl_add_lightbutton(FL_PUSH_BUTTON,30,55,190,30,"Battle Manager");
    ...
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,BMCnoneCB,0);
  fdui->subs_mon = obj = fl_add_lightbutton(FL_PUSH_BUTTON,30,95,190,30,"Execution Monitor");
    fl_set_object_color(obj,FL_RED,FL_GREEN);
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,BMCnoneCB,0);
  fdui->subs_sim = obj = fl_add_lightbutton(FL_PUSH_BUTTON,265,55,190,30,"Simulator");
    ...
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,BMCnoneCB,0);
  fdui->subs_cop = obj = fl_add_lightbutton(FL_PUSH_BUTTON,265,95,190,30,"Fused Operating Picture");
    fl_set_object_color(obj,FL_RED,FL_GREEN);
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,BMCnoneCB,0);
  fdui->subs_ext = obj = fl_add_lightbutton(FL_PUSH_BUTTON,30,175,190,30,"External Interface");
    fl_set_object_color(obj,FL_RED,FL_GREEN);
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,BMCnoneCB,0);
  fdui->subs_multi = obj = fl_add_lightbutton(FL_PUSH_BUTTON,125,220,190,30,"Multi-Threaded Tools");
    fl_set_object_color(obj,FL_RED,FL_GREEN);
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,BMCnoneCB,0);
  fdui->subs_link = obj = fl_add_lightbutton(FL_PUSH_BUTTON,265,135,190,30,"Link Analyzer");
    fl_set_object_color(obj,FL_RED,FL_GREEN);
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,BMCnoneCB,0);
  fdui->subs_kb = obj = fl_add_lightbutton(FL_PUSH_BUTTON,30,135,190,30,"Knowledge Base");
    fl_set_object_color(obj,FL_RED,FL_GREEN);
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,BMCnoneCB,0);
  fdui->subs_dis = obj = fl_add_lightbutton(FL_PUSH_BUTTON,265,175,190,30,"DIS Interface");
    fl_set_object_color(obj,FL_RED,FL_GREEN);
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_callback(obj,BMCnoneCB,0);
